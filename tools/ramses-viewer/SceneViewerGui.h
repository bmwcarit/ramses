...
namespace ramses::internal
{
    ...
    private:
        ...
        void drawLogicEngine(LogicEngineImpl& obj);
        void drawLogicObject(LogicObjectImpl& obj);
        ...
        static void DrawIssues(const SceneObjectImpl& obj, const ValidationCache& report);
