...
namespace ramses::internal
{
    ...
    {
    public:
        ResourceList(ramses::Scene& scene, const ramses::internal::SceneDumper::RamsesObjectImplSet& usedObjects)
            : m_scene(scene)
         ...
         * The returned index can be used to access an item in #ramses::internal::ResourceList::orderCriteriaItems
         */
    ...
    private:
        ...
        static uint32_t GetCompressedSize(const ramses::internal::ManagedResource& resource)
        {
        ...
        const ramses::internal::SceneDumper::RamsesObjectImplSet& m_usedObjects;

        SceneObjectVector m_objects;

        std::unordered_multimap<ramses::internal::ResourceContentHash, ramses::Resource*> m_hashLookup;
