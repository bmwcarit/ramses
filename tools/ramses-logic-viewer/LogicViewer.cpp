...
namespace ramses
{
    ...
    Result LogicViewer::saveDefaultLuaFile(const std::string& filename, const LogicViewerSettings& settings)
    {
        ...
        log.logAllInputs<NodeBinding>("--Node bindings\n", LogicViewer::ltnNode);
        log.logAllInputs<AppearanceBinding>("--Appearance bindings\n", LogicViewer::ltnAppearance);
        log.logAllInputs<CameraBinding>("--Camera bindings\n", LogicViewer::ltnCamera);
        log.logAllInputs<RenderPassBinding>("--RenderPass bindings\n", LogicViewer::ltnRenderPass);
        log.logAllInputs<RenderGroupBinding>("--RenderGroup bindings\n", LogicViewer::ltnRenderGroup);
        log.logAllInputs<MeshNodeBinding>("--MeshNode bindings\n", LogicViewer::ltnMeshNode);
