...
namespace ramses_internal
{
    ...
    public:
        ...
        MOCK_METHOD(DeviceResourceHandle, uploadBinaryShader, (const EffectResource&, const uint8_t* binaryShaderData, UInt32 binaryShaderDataSize, BinaryShaderFormatID binaryShaderFormat), (override));
        ...
        MOCK_METHOD(DeviceResourceHandle, uploadStreamTexture2D, (DeviceResourceHandle handle, UInt32 width, UInt32 height, ETextureFormat format, const uint8_t* data, const TextureSwizzleArray& swizzle), (override));
        ...
        MOCK_METHOD(void, readPixels, (uint8_t*, UInt32, UInt32, UInt32, UInt32), (override));
