...
public:
    ...
    MOCK_METHOD(bool, getResourceData, (ResourceContentHash, uint8_t*, UInt32), (const, override));
    MOCK_METHOD(bool, shouldResourceBeCached, (ResourceContentHash, UInt32, ResourceCacheFlag, SceneId), (const, override));
    MOCK_METHOD(void, storeResource, (ResourceContentHash, const uint8_t*, UInt32, ResourceCacheFlag, SceneId), (override));
};
}
#endif
