...
namespace ramses_internal
{
    ...
    class RendererSceneControlEventChainer final : public ramses::IRendererSceneControlEventHandler_legacy
    {
    public:
        RendererSceneControlEventChainer(ramses::IRendererSceneControlEventHandler_legacy& handler1, ramses::IRendererSceneControlEventHandler_legacy& handler2)
            : m_handler1(handler1)
            , m_handler2(handler2)
        {
        }
    ...
    private:
        ramses::IRendererSceneControlEventHandler_legacy& m_handler1;
        ramses::IRendererSceneControlEventHandler_legacy& m_handler2;
    };
}
