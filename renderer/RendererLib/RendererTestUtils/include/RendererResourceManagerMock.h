...
public:
    ...
    MOCK_METHOD(void, updateTextureBuffer, (TextureBufferHandle textureBufferHandle, UInt32 mipLevel, const Quad& area, UInt32 stride, const Byte* data, SceneId sceneId), (override));
