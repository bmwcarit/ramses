...
namespace ramses_internal
{
    ...
    public:
        ...
        virtual Bool execute(uint64_t& sceneId, uint32_t& dataSlot, uint32_t& bufferId) const override;
    ...
    public:
        ...
        virtual Bool execute(uint64_t& sceneId, uint32_t& dataSlot) const override;
