...
TEST_F(AWarpingPass, ValidRenderBackendCallsOnExecute)
{
    ...
    EXPECT_CALL(device, setTextureSampling(Ne(DataFieldHandle::Invalid()), EWrapMethod_Clamp, EWrapMethod_Clamp, EWrapMethod_Clamp, ESamplingMethod_Bilinear, isotropicFilteringLevel));
