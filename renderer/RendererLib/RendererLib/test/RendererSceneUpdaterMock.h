...
namespace ramses_internal
{
    ...
    public:
        ...
        MOCK_METHOD(bool, handleBufferCreateRequest, (OffscreenBufferHandle buffer, uint32_t width, uint32_t height, uint32_t sampleCount, bool isDoubleBuffered, ERenderBufferType depthStencilBufferType), (override));
