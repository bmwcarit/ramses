...
{
    const int32_t xCoordDisplaySpace = static_cast<int32_t>(std::lroundf((coords.x + 1.f) * dispResolution.x / 2.f));
    const int32_t yCoordDisplaySpace = static_cast<int32_t>(std::lroundf((coords.y + 1.f) * dispResolution.y / 2.f));
