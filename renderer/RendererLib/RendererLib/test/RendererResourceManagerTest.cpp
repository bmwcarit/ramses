...
{
    auto effectRes = std::make_unique<const EffectResource>("", "", "", std::optional<EDrawMode>{}, EffectInputInformationVector{}, EffectInputInformationVector{}, "", ResourceCacheFlag_DoNotCache);
