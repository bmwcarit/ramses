...
namespace ramses_internal
{
    ...
    {
    public:
        RendererInterruptState(DisplayHandle display = DisplayHandle::Invalid(), DeviceResourceHandle displayBuffer = DeviceResourceHandle::Invalid(), SceneId sceneId = SceneId::Invalid(), const SceneRenderExecutionIterator& executorState = {})
            : m_display(display)
