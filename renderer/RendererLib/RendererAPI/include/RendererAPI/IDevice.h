...
namespace ramses_internal
{
    ...
    public:
        ...
        virtual DeviceResourceHandle    uploadBinaryShader          (const EffectResource& effect, const uint8_t* binaryShaderData, UInt32 binaryShaderDataSize, BinaryShaderFormatID binaryShaderFormat) = 0;
        ...
        virtual DeviceResourceHandle    uploadStreamTexture2D       (DeviceResourceHandle handle, UInt32 width, UInt32 height, ETextureFormat format, const uint8_t* data, const TextureSwizzleArray& swizzle) = 0;
        ...
        virtual void readPixels(uint8_t* buffer, UInt32 x, UInt32 y, UInt32 width, UInt32 height) = 0;
