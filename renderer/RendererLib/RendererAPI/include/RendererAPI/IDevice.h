...
namespace ramses_internal
{
    ...
    public:
        ...
        // data
        virtual void setConstant(DataFieldHandle field, uint32_t count, const float*      value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::vec2*    value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::vec3*    value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::vec4*    value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const int32_t*      value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::ivec2*   value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::ivec3*   value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::ivec4*   value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::mat2*  value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::mat3*  value) = 0;
        virtual void setConstant(DataFieldHandle field, uint32_t count, const glm::mat4*  value) = 0;

        //draw calls
        virtual void clear               (uint32_t clearFlags) = 0;
        ...
        virtual void                    uploadVertexBufferData      (DeviceResourceHandle handle, const Byte* data, uint32_t dataSize) = 0;
        ...
        virtual void                    uploadIndexBufferData       (DeviceResourceHandle handle, const Byte* data, uint32_t dataSize) = 0;
        ...
        virtual DeviceResourceHandle    uploadBinaryShader          (const EffectResource& effect, const uint8_t* binaryShaderData, uint32_t binaryShaderDataSize, BinaryShaderFormatID binaryShaderFormat) = 0;
        ...
        virtual DeviceResourceHandle    allocateTexture2D           (uint32_t width, uint32_t height, ETextureFormat textureFormat, const TextureSwizzleArray& swizzle, uint32_t mipLevelCount, uint32_t totalSizeInBytes) = 0;
        virtual DeviceResourceHandle    allocateTexture3D           (uint32_t width, uint32_t height, uint32_t depth, ETextureFormat textureFormat, uint32_t mipLevelCount, uint32_t totalSizeInBytes) = 0;
        virtual DeviceResourceHandle    allocateTextureCube         (uint32_t faceSize, ETextureFormat textureFormat, const TextureSwizzleArray& swizzle, uint32_t mipLevelCount, uint32_t totalSizeInBytes) = 0;
        ...
        virtual void                    uploadTextureData           (DeviceResourceHandle handle, uint32_t mipLevel, uint32_t x, uint32_t y, uint32_t z, uint32_t width, uint32_t height, uint32_t depth, const Byte* data, uint32_t dataSize) = 0;
        virtual DeviceResourceHandle    uploadStreamTexture2D       (DeviceResourceHandle handle, uint32_t width, uint32_t height, ETextureFormat format, const uint8_t* data, const TextureSwizzleArray& swizzle) = 0;
