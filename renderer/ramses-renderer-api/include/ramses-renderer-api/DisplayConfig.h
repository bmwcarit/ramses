...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API status_t setDeviceType(EDeviceType deviceType);
        ...
        */
        [[nodiscard]] RAMSES_API EDeviceType getDeviceType() const;
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setWindowType(EWindowType windowType);
        ...
        */
        [[nodiscard]] RAMSES_API EWindowType getWindowType() const;
        ...
        */
        [[nodiscard]] RAMSES_API  void* getIOSNativeWindow() const;
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setIOSNativeWindow(void* nativeWindowPtr);
