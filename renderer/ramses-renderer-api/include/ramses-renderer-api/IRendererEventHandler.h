    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief This method will be called if a scene which is being monitored for latency (see \c SceneConfig::setMaximumLatency)
        *        exceeded the time limit given by client providing the scene (see \c Scene::flushWithTimestamp).
        *        This callback is called only once when latency is exceeded and is being continuously exceeded every frame.
        *        When the latency gets back down to the limit the \c sceneUpdateLatencyBackBelowLimit is called.
        * @param sceneId The scene id of the scene on which the event occurred
        */
        ...
        /**
        * @brief This method will be called if a scene which is being monitored for latency (see \c SceneConfig::setMaximumLatency)
        *        and previously exceeded given time limit now got back down to limit.
        *        This callback is called only once when latency got back down to limit and stays there.
        *        If the latency exceeds the limit again the \c sceneUpdateLatencyExceeded is called.
        * @param sceneId The scene id of the scene on which the event occurred
        */
        ...
        */
        ...
        {
            // This callback has default implementation to improve compatibility between RAMSES 17 and RAMSES 18
            // Will become pure virtual method (with default implementation in RendererEventHandlerEmpty) in the future
            UNUSED(streamId);
            UNUSED(available);
        }
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            UNUSED(providerScene);
            UNUSED(providerId);
            UNUSED(consumerScene);
            UNUSED(consumerId);
            UNUSED(result);
        }
        ...
        */
        ...
        {
            UNUSED(providerOffscreenBuffer);
            UNUSED(consumerScene);
            UNUSED(consumerId);
            UNUSED(result);
        }
        ...
        */
        ...
        {
            UNUSED(sceneId);
            UNUSED(sceneVersionTag);
            UNUSED(resourceStatus);
        }
