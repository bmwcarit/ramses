...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API displayBufferId_t createOffscreenBuffer(displayId_t display, uint32_t width, uint32_t height, uint32_t sampleCount = 0u, EDepthBufferType depthBufferType = EDepthBufferType::DepthStencil);
        ...
        *         Note that the buffer will be created asynchronously and there will be a renderer event once the operation is finished.
        */
        RAMSES_API displayBufferId_t createInterruptibleOffscreenBuffer(displayId_t display, uint32_t width, uint32_t height, EDepthBufferType depthBufferType = EDepthBufferType::DepthStencil);
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t takeSystemCompositorScreenshot(std::string_view fileName, int32_t screenIviId);
