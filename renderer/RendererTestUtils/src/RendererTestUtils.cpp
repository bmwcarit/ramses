...
void RendererTestUtils::SaveScreenshotForDisplay(ramses::RamsesRenderer& renderer, ramses::displayId_t displayId, ramses::displayBufferId_t displayBuffer, UInt32 x, UInt32 y, UInt32 width, UInt32 height, const std::string& screenshotFileName)
{
