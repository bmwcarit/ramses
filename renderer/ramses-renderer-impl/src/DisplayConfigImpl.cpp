...
namespace ramses
{
    ...
    status_t DisplayConfigImpl::setDeviceType(EDeviceType deviceType)
    {
        switch (deviceType)
        {
        case EDeviceType::GLES_3_0:
            m_internalConfig.setDeviceType(ramses_internal::EDeviceType::GLES_3_0);
            break;
        case EDeviceType::GL_4_2:
            m_internalConfig.setDeviceType(ramses_internal::EDeviceType::GL_4_2);
            break;
        case EDeviceType::GL_4_5:
            m_internalConfig.setDeviceType(ramses_internal::EDeviceType::GL_4_5);
            break;
        }
    ...
    {
        switch (m_internalConfig.getDeviceType())
        {
        case ramses_internal::EDeviceType::GLES_3_0:
            return EDeviceType::GLES_3_0;
        case ramses_internal::EDeviceType::GL_4_2:
            return EDeviceType::GL_4_2;
        case ramses_internal::EDeviceType::GL_4_5:
            return EDeviceType::GL_4_5;
        }
    ...
    status_t DisplayConfigImpl::setWindowType(EWindowType windowType)
    {
        switch (windowType)
        {
        case ramses::EWindowType::Windows:
            m_internalConfig.setWindowType(ramses_internal::EWindowType::Windows);
            break;
        case ramses::EWindowType::X11:
            m_internalConfig.setWindowType(ramses_internal::EWindowType::X11);
            break;
        case ramses::EWindowType::Wayland_IVI:
            m_internalConfig.setWindowType(ramses_internal::EWindowType::Wayland_IVI);
            break;
        case ramses::EWindowType::Wayland_Shell:
    ...
    {
        switch (m_internalConfig.getWindowType())
        {
        case ramses_internal::EWindowType::Windows:
            return EWindowType::Windows;
        case ramses_internal::EWindowType::X11:
            return EWindowType::X11;
        case ramses_internal::EWindowType::Wayland_IVI:
            return EWindowType::Wayland_IVI;
        case ramses_internal::EWindowType::Wayland_Shell:
    ...
    status_t DisplayConfigImpl::validate() const
    {
        ...
        if(embeddedCompositorFilename.size() == 0u && embeddedCompositorFileDescriptor < 0)
            status = addValidationMessage(EValidationSeverity::Info, "no socket information for EmbeddedCompositor set (neither file descriptor nor file name). No embedded compositor available.");
        else if(embeddedCompositorFilename.size() > 0u && embeddedCompositorFileDescriptor >= 0)
            status = addValidationMessage(EValidationSeverity::Info, "Competing settings for EmbeddedCompositor are set (file descriptor and file name). File descriptor setting will be preferred.");
