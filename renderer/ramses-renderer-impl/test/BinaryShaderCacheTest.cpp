...
public:
    ...
    void createTestFile()
    {
        ...
        const UInt32             shaderDataSize1 = sizeof(shaderData1) / sizeof(uint8_t);
        ...
        const UInt32             shaderDataSize2 = sizeof(shaderData2) / sizeof(uint8_t);
...
TEST_F(ABinaryShaderCache, canStoreAndGetBinaryShader)
{
    ...
    const UInt32 shaderDataSize = sizeof(shaderData) / sizeof(uint8_t);
