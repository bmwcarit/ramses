...
namespace ramses_internal
{
    ...
    void Platform_X11_EGL_ES_3_0::getSurfaceAttributes(UInt32 msaaSampleCount, Vector<EGLint>& attributes) const
    {
        attributes.clear();
    ...
    void Platform_X11_EGL_ES_3_0::getContextAttributes(Vector<EGLint>& attributes) const
    {
        attributes.clear();
