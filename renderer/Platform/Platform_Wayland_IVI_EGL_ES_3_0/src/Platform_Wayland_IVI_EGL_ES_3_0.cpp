...
namespace ramses_internal
{
    ...
    void Platform_Wayland_IVI_EGL_ES_3_0::getSurfaceAttributes(UInt32 msaaSampleCount, std::vector<EGLint>& attributes) const
    {
        attributes.clear();
    ...
    void Platform_Wayland_IVI_EGL_ES_3_0::getContextAttributes(std::vector<EGLint>& attributes) const
    {
        attributes.clear();
