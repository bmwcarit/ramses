...
namespace ramses_internal
{
    ...
    {
    public:
        Context_WGL(ERenderBufferType depthStencilBufferType, HDC displayHandle, WglExtensions procs, EDeviceType deviceType, UInt32 msaaSampleCount);
        Context_WGL(Context_WGL& sharedContext, HDC displayHandle, WglExtensions procs, UInt32 msaaSampleCount);
