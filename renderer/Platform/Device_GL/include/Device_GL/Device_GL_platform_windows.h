...
#define LOAD_ALL_API_PROCS                                                                          \
LOAD_API_PROC(m_context, PFNGLGETSTRINGIPROC, glGetStringi);                                        \
LOAD_API_PROC(m_context, PFNGLCREATEPROGRAMPROC, glCreateProgram);                                  \
LOAD_API_PROC(m_context, PFNGLDELETEPROGRAMPROC, glDeleteProgram);                                  \
LOAD_API_PROC(m_context, PFNGLUSEPROGRAMPROC, glUseProgram);                                        \
LOAD_API_PROC(m_context, PFNGLPROGRAMBINARYPROC, glProgramBinary);                                  \
LOAD_API_PROC(m_context, PFNGLGETPROGRAMBINARYPROC, glGetProgramBinary);                            \
LOAD_API_PROC(m_context, PFNGLATTACHSHADERPROC, glAttachShader);                                    \
LOAD_API_PROC(m_context, PFNGLDETACHSHADERPROC, glDetachShader);                                    \
LOAD_API_PROC(m_context, PFNGLLINKPROGRAMPROC, glLinkProgram);                                      \
LOAD_API_PROC(m_context, PFNGLGETPROGRAMIVPROC, glGetProgramiv);                                    \
LOAD_API_PROC(m_context, PFNGLGETSHADERINFOLOGPROC, glGetShaderInfoLog);                            \
LOAD_API_PROC(m_context, PFNGLGETUNIFORMLOCATIONPROC, glGetUniformLocation);                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM1IPROC, glUniform1i);                                          \
LOAD_API_PROC(m_context, PFNGLUNIFORM1IVPROC, glUniform1iv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM2IVPROC, glUniform2iv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM3IVPROC, glUniform3iv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM4IVPROC, glUniform4iv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM1FPROC, glUniform1f);                                          \
LOAD_API_PROC(m_context, PFNGLUNIFORM1FVPROC, glUniform1fv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM2FVPROC, glUniform2fv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM3FVPROC, glUniform3fv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORM4FVPROC, glUniform4fv);                                        \
LOAD_API_PROC(m_context, PFNGLUNIFORMMATRIX2FVPROC, glUniformMatrix2fv);                            \
LOAD_API_PROC(m_context, PFNGLUNIFORMMATRIX3FVPROC, glUniformMatrix3fv);                            \
LOAD_API_PROC(m_context, PFNGLUNIFORMMATRIX4FVPROC, glUniformMatrix4fv);                            \
LOAD_API_PROC(m_context, PFNGLGETATTRIBLOCATIONPROC, glGetAttribLocation);                          \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIB1FPROC, glVertexAttrib1f);                                \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIB1FVPROC, glVertexAttrib1fv);                              \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIB2FVPROC, glVertexAttrib2fv);                              \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIB3FVPROC, glVertexAttrib3fv);                              \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIB4FVPROC, glVertexAttrib4fv);                              \
LOAD_API_PROC(m_context, PFNGLENABLEVERTEXATTRIBARRAYPROC, glEnableVertexAttribArray);              \
LOAD_API_PROC(m_context, PFNGLBINDATTRIBLOCATIONPROC, glBindAttribLocation);                        \
LOAD_API_PROC(m_context, PFNGLGETACTIVEUNIFORMPROC, glGetActiveUniform);                            \
LOAD_API_PROC(m_context, PFNGLGETACTIVEATTRIBPROC, glGetActiveAttrib);                              \
LOAD_API_PROC(m_context, PFNGLGETPROGRAMINFOLOGPROC, glGetProgramInfoLog);                          \
LOAD_API_PROC(m_context, PFNGLCREATESHADERPROC, glCreateShader);                                    \
LOAD_API_PROC(m_context, PFNGLDELETESHADERPROC, glDeleteShader);                                    \
LOAD_API_PROC(m_context, PFNGLSHADERSOURCEPROC, glShaderSource);                                    \
LOAD_API_PROC(m_context, PFNGLCOMPILESHADERPROC, glCompileShader);                                  \
LOAD_API_PROC(m_context, PFNGLGETSHADERIVPROC, glGetShaderiv);                                      \
LOAD_API_PROC(m_context, PFNGLGENVERTEXARRAYSPROC, glGenVertexArrays);                              \
LOAD_API_PROC(m_context, PFNGLBINDVERTEXARRAYPROC, glBindVertexArray);                              \
LOAD_API_PROC(m_context, PFNGLGENBUFFERSPROC, glGenBuffers);                                        \
LOAD_API_PROC(m_context, PFNGLBINDBUFFERPROC, glBindBuffer);                                        \
LOAD_API_PROC(m_context, PFNGLBUFFERDATAPROC, glBufferData);                                        \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIBPOINTERPROC, glVertexAttribPointer);                      \
LOAD_API_PROC(m_context, PFNGLGENFRAMEBUFFERSPROC, glGenFramebuffers);                              \
LOAD_API_PROC(m_context, PFNGLBINDFRAMEBUFFERPROC, glBindFramebuffer);                              \
LOAD_API_PROC(m_context, PFNGLBLITFRAMEBUFFERPROC, glBlitFramebuffer);                              \
LOAD_API_PROC(m_context, PFNGLDELETEFRAMEBUFFERSPROC, glDeleteFramebuffers);                        \
LOAD_API_PROC(m_context, PFNGLFRAMEBUFFERTEXTURE2DPROC, glFramebufferTexture2D);                    \
LOAD_API_PROC(m_context, PFNGLDELETEBUFFERSPROC, glDeleteBuffers);                                  \
LOAD_API_PROC(m_context, PFNGLCHECKFRAMEBUFFERSTATUSPROC, glCheckFramebufferStatus);                \
LOAD_API_PROC(m_context, PFNGLGENRENDERBUFFERSPROC, glGenRenderbuffers);                            \
LOAD_API_PROC(m_context, PFNGLBINDRENDERBUFFERPROC, glBindRenderbuffer);                            \
LOAD_API_PROC(m_context, PFNGLRENDERBUFFERSTORAGEPROC, glRenderbufferStorage);                      \
LOAD_API_PROC(m_context, PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC, glRenderbufferStorageMultisample);\
LOAD_API_PROC(m_context, PFNGLFRAMEBUFFERRENDERBUFFERPROC, glFramebufferRenderbuffer);              \
LOAD_API_PROC(m_context, PFNGLDRAWBUFFERSPROC, glDrawBuffers);                                      \
LOAD_API_PROC(m_context, PFNGLDELETERENDERBUFFERSPROC, glDeleteRenderbuffers);                      \
LOAD_API_PROC(m_context, PFNGLACTIVETEXTUREPROC, glActiveTexture);                                  \
LOAD_API_PROC(m_context, PFNGLBLENDEQUATIONPROC, glBlendEquation);                                  \
LOAD_API_PROC(m_context, PFNGLBLENDEQUATIONSEPARATEPROC, glBlendEquationSeparate);                  \
LOAD_API_PROC(m_context, PFNGLBLENDFUNCSEPARATEPROC, glBlendFuncSeparate);                          \
LOAD_API_PROC(m_context, PFNGLGENERATEMIPMAPPROC, glGenerateMipmap);                                \
                                                                                                    \
LOAD_API_PROC(m_context, PFNGLCLEARDEPTHFPROC, glClearDepthf);                                      \
LOAD_API_PROC(m_context, PFNGLCOMPRESSEDTEXIMAGE2DPROC, glCompressedTexImage2D);                    \
LOAD_API_PROC(m_context, PFNGLGENSAMPLERSPROC, glGenSamplers);                                      \
LOAD_API_PROC(m_context, PFNGLDELETESAMPLERSPROC, glDeleteSamplers);                                \
LOAD_API_PROC(m_context, PFNGLBINDSAMPLERPROC, glBindSampler);                                      \
LOAD_API_PROC(m_context, PFNGLSAMPLERPARAMETERIPROC, glSamplerParameteri);                          \
LOAD_API_PROC(m_context, PFNGLSHADERBINARYPROC, glShaderBinary);                                    \
LOAD_API_PROC(m_context, PFNGLDRAWELEMENTSINSTANCEDPROC, glDrawElementsInstanced);                  \
LOAD_API_PROC(m_context, PFNGLDRAWARRAYSINSTANCEDPROC, glDrawArraysInstanced);                      \
LOAD_API_PROC(m_context, PFNGLVERTEXATTRIBDIVISORPROC, glVertexAttribDivisor);                      \
LOAD_API_PROC(m_context, PFNGLTEXSTORAGE2DPROC, glTexStorage2D);                                    \
LOAD_API_PROC(m_context, PFNGLTEXSTORAGE3DPROC, glTexStorage3D);                                    \
LOAD_API_PROC(m_context, PFNGLTEXSUBIMAGE3DPROC, glTexSubImage3D);                                  \
LOAD_API_PROC(m_context, PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC, glCompressedTexSubImage2D);              \
LOAD_API_PROC(m_context, PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC, glCompressedTexSubImage3D);              \
