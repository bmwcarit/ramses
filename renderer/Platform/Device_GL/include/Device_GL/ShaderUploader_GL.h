...
namespace ramses_internal
{
    ...
    public:
        ...
        static bool UploadShaderProgramFromBinary(const uint8_t* binaryShaderData, UInt32 binaryShaderDataSize, BinaryShaderFormatID binaryShaderFormat, ShaderProgramInfo& programShaderInfoOut, std::string& debugErrorLog);
