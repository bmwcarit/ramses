...
#ifndef RAMSES_PLATFORM_WAYLAND_IVI_EGL_H
#define RAMSES_PLATFORM_WAYLAND_IVI_EGL_H

#include "Platform_Wayland_EGL/Platform_Wayland_EGL.h"

namespace ramses_internal
{
    class Platform_Wayland_IVI_EGL : public Platform_Wayland_EGL
    {
    protected:
        explicit Platform_Wayland_IVI_EGL(const RendererConfig& rendererConfig);
