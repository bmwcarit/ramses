...
{
    Platform_Wayland_IVI_EGL::Platform_Wayland_IVI_EGL(const RendererConfig& rendererConfig)
        : Platform_Wayland_EGL(rendererConfig)
    {
    }

    ISystemCompositorController* Platform_Wayland_IVI_EGL::createSystemCompositorController()
    {
    ...
    IWindow* Platform_Wayland_IVI_EGL::createWindow(const DisplayConfig& displayConfig, IWindowEventHandler& windowEventHandler)
    {
    ...
    Bool Platform_Wayland_IVI_EGL::destroyWindow(IWindow &window)
    {
