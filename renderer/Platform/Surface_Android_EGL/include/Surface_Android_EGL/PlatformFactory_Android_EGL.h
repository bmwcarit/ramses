...
#ifndef RAMSES_PLATFORMFACTORY_ANDROID_EGL_H
#define RAMSES_PLATFORMFACTORY_ANDROID_EGL_H
...
{
    class PlatformFactory_Android_EGL : public PlatformFactory_Base
    {
    protected:
        PlatformFactory_Android_EGL(const RendererConfig& rendererConfig);
