...
class TestMultiplRenderTargets(test_classes.OnSelectedTargetsTest):
    ...
    def impl_test(self):
        self.renderer.showScene(41)

        self.validateScreenshot(self.renderer, "testClient_multipleRenderTargets.png")
