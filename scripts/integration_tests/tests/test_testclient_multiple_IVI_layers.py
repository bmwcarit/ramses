...
class TestMultipleIVILayers(test_classes.OnSelectedTargetsTest):
    ...
    def impl_setUp(self):
        ...
        self.testClient3Triangles = self.target.start_client("ramses-test-client", "--test-nr 21 --test-state 0 --cz 5")
        ...
        self.testClientRedTriangles = self.target.start_client("ramses-test-client", "--test-nr 20 --test-state 0 --cz 5")
