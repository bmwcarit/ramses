...
class TestClass(test_classes.OnAllDefaultTargetsTest):
    ...
    def impl_setUp(self):
        ...
        self.testClient = self.target.start_client("ramses-test-client", "--test-nr 2 --cz 5")
    ...
    def impl_test(self):
        self.renderer.showScene(21)
        self.renderer.showScene(22)

        self.validateScreenshot(self.renderer, "testClient_twoScenes.png")
