...
class TestClass(test_classes.OnAllDefaultTargetsTest):
    ...
    def impl_setUp(self):
        ...
        self.testClient = self.target.start_client("ramses-test-client", "--test-nr 7 --test-state 0 --cz 80")
    ...
    def impl_test(self):
        ...
        self.renderer.showScene(32)

        self.validateScreenshot(self.renderer, "testClient_multiScene.png")
