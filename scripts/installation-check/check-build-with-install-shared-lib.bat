...
echo "++++ Create test environment for install check of shared lib (%BUILD_CONFIG%) ++++"
...
cmake -G%CMAKE_GENERATOR% -DCMAKE_PREFIX_PATH="%INSTALL_DIR%/lib" -DRAMSES_RENDERER_PLATFORM="WINDOWS" -DGL_VERSION="GLES3.0;GL4.2;GL4.5" --build test-cmake.config %SCRIPT_DIR%/shared-lib-check/
