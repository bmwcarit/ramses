...
* -Dramses-sdk_ENABLE_WAYLAND_IVI
    * options: ON/OFF
    * default: ON
    * Builds a version of the ramses shared library which supports the wayland IVI protocol.

* -Dramses-sdk_ENABLE_WAYLAND_SHELL
    * options: ON/OFF
    * default: ON
    * Builds a version of the ramses shared library which supports the wayland shell protocol.
