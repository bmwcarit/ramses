...
{
    TextureUploadParams_GL TypesConversion_GL::GetTextureUploadParams(EPixelStorageFormat format)
    {
        ...
        case EPixelStorageFormat::RGBA32F:
            ...
            uploadParams.baseInternalFormat = GL_RGBA;
            uploadParams.type = GL_FLOAT;
            uploadParams.byteAlignment = 8; // actually 16 bytes but glPixelStore accepts maximum 8 bytes alignment
            break;
        ...
        case EPixelStorageFormat::Depth32:
            uploadParams.sizedInternalFormat = GL_DEPTH_COMPONENT32F;
            uploadParams.baseInternalFormat = GL_DEPTH_COMPONENT;
            uploadParams.byteAlignment = 4;
            break;
        ...
        case EPixelStorageFormat::Invalid:
            assert(false);
            break;
        }
    ...
    GLint TypesConversion_GL::GetWrapMode(ETextureAddressMode wrapMode)
    {
        switch (wrapMode)
        {
    ...
    GLint TypesConversion_GL::GetASTCFormat(EPixelStorageFormat ramsesEnum)
    {
        switch (ramsesEnum)
        {
        case EPixelStorageFormat::ASTC_RGBA_4x4:
    ...
    EPixelStorageFormat TypesConversion_GL::GetTextureFormatFromCompressedGLTextureFormat(GLenum compressedGLTextureFormat)
    {
        ...
        case GL_COMPRESSED_RGBA_ASTC_4x4_KHR:
            return EPixelStorageFormat::ASTC_RGBA_4x4;
        case GL_COMPRESSED_RGBA_ASTC_5x4_KHR:
            return EPixelStorageFormat::ASTC_RGBA_5x4;
        case GL_COMPRESSED_RGBA_ASTC_5x5_KHR:
            return EPixelStorageFormat::ASTC_RGBA_5x5;
        case GL_COMPRESSED_RGBA_ASTC_6x5_KHR:
            return EPixelStorageFormat::ASTC_RGBA_6x5;
        case GL_COMPRESSED_RGBA_ASTC_6x6_KHR:
            return EPixelStorageFormat::ASTC_RGBA_6x6;
        case GL_COMPRESSED_RGBA_ASTC_8x5_KHR:
            return EPixelStorageFormat::ASTC_RGBA_8x5;
        case GL_COMPRESSED_RGBA_ASTC_8x6_KHR:
            return EPixelStorageFormat::ASTC_RGBA_8x6;
        case GL_COMPRESSED_RGBA_ASTC_8x8_KHR:
            return EPixelStorageFormat::ASTC_RGBA_8x8;
        case GL_COMPRESSED_RGBA_ASTC_10x5_KHR:
            return EPixelStorageFormat::ASTC_RGBA_10x5;
        case GL_COMPRESSED_RGBA_ASTC_10x6_KHR:
            return EPixelStorageFormat::ASTC_RGBA_10x6;
        case GL_COMPRESSED_RGBA_ASTC_10x8_KHR:
            return EPixelStorageFormat::ASTC_RGBA_10x8;
        case GL_COMPRESSED_RGBA_ASTC_10x10_KHR:
            return EPixelStorageFormat::ASTC_RGBA_10x10;
        case GL_COMPRESSED_RGBA_ASTC_12x10_KHR:
            return EPixelStorageFormat::ASTC_RGBA_12x10;
        case GL_COMPRESSED_RGBA_ASTC_12x12_KHR:
            return EPixelStorageFormat::ASTC_RGBA_12x12;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_4x4;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_5x4;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_5x5;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_6x5;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_6x6;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_8x5;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_8x6;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_8x8;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_10x5;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_10x6;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_10x8;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_10x10;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_12x10;
        case GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:
            return EPixelStorageFormat::ASTC_SRGBA_12x12;
    ...
    GLint TypesConversion_GL::GetGlColorFromTextureChannelColor(ETextureChannelColor color)
    {
        switch (color)
        {
