...
namespace ramses::internal
{
    ...
    LinuxDmabufBufferData::PlaneData::PlaneData() = default;
    ...
    void LinuxDmabufBufferData::noopDestroyCallback([[maybe_unused]] LinuxDmabufBufferData* dmabuf) {}

    void LinuxDmabufBufferData::clearDestroyCallback()
    {
        setDestroyCallback([this](LinuxDmabufBufferData* dmabuf) { noopDestroyCallback(dmabuf); });
    }
