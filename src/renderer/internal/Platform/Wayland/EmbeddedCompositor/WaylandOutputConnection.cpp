...
namespace ramses::internal
{
        ...
        , m_clientCredentials(client.getCredentials())
    {
        ...
        m_resource = client.resourceCreate(&wl_output_interface, static_cast<int>(version), id);
    ...
    void WaylandOutputConnection::OutputReleaseCallback([[maybe_unused]] wl_client* client, wl_resource *clientResource)
    {
        auto* outputConnection =
            static_cast<WaylandOutputConnection*>(wl_resource_get_user_data(clientResource));
        delete outputConnection;
