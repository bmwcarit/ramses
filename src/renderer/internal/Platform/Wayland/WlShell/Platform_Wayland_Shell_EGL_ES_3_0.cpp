...
{
    Platform_Wayland_Shell_EGL_ES_3_0::Platform_Wayland_Shell_EGL_ES_3_0(const RendererConfigData& rendererConfig)
        : Platform_Wayland_EGL(rendererConfig)
    {
    }

    bool Platform_Wayland_Shell_EGL_ES_3_0::createWindow(const DisplayConfigData& displayConfig, IWindowEventHandler& windowEventHandler)
    {
