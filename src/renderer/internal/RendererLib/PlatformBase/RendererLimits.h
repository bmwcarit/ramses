...
namespace ramses::internal
{
    ...
    public:
        ...
        // Texture formats
        [[nodiscard]] bool isTextureFormatAvailable(EPixelStorageFormat format) const;
        void addTextureFormat(EPixelStorageFormat format);
    ...
    private:
        ...
        HashSet<EPixelStorageFormat> m_availableTextureFormats;
    };
}
