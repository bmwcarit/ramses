...
namespace ramses::internal
{
    ...
    bool SystemCompositorControllerScreenshot::execute(std::string& fileName, int32_t& screenIviId) const
    {
        m_rendererCommandBuffer.enqueueCommand(ramses::internal::RendererCommand::SCScreenshot{ screenIviId, fileName });
        return true;
    }
}
