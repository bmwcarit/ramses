...
namespace ramses::internal
{
    ...
    {
        m_rendererCommandBuffer.enqueueCommand(ramses::internal::RendererCommand::SCAddIviSurfaceToIviLayer{ WaylandIviSurfaceId(surfaceId), WaylandIviLayerId(layerId) });
        return true;
    }
}
