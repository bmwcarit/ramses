...
namespace ramses::internal
{
    namespace RendererCommandUtils
    {
        ...
        inline std::string ToString(const RendererCommand::CreateDmaOffscreenBuffer& cmd) { return fmt::format("CreateOffscreenBuffer (displayId={} OB={} wh={}x{} fourccFormat={} usage={} modifiers={})",
                                                                                                               cmd.display, cmd.offscreenBuffer, cmd.width, cmd.height, cmd.dmaBufferFourccFormat.getValue(), cmd.dmaBufferUsageFlags.getValue(), cmd.dmaBufferModifiers.getValue()); }
        ...
        inline std::string ToString(const RendererCommand::LogStatistics& /*unused*/) { return "LogStatistics"; }
        inline std::string ToString(const RendererCommand::LogInfo& /*unused*/) { return "LogInfo"; }
        inline std::string ToString(const RendererCommand::SCListIviSurfaces& /*unused*/) { return "SCListIviSurfaces"; }
        ...
        template <>
        inline RendererCommand::Variant CreateVariantFrom<RendererCommand::UpdateScene>(const RendererCommand::UpdateScene& /*unused*/)
        {
        ...
        template <typename T>
        RendererEvent GenerateFailEventForCommand(const T& /*unused*/)
        {
