...
namespace ramses::internal
{
    ...
    public:
        ...
        DataInstanceHandle          allocateDataInstance        (DataLayoutHandle handle, DataInstanceHandle instanceHandle) override;
    ...
    private:
        ...
        static bool IsGeometryDataLayout(const DataLayout& layout);
