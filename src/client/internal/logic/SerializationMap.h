...
namespace ramses::internal
{
    ...
    public:
        ...
        void storeDataArray(sceneObjectId_t id, flatbuffers::Offset<rlogic_serialization::DataArray> offset)
        {
            assert(id.isValid());
            Store(id, offset, m_dataArrays);
        }

        [[nodiscard]] flatbuffers::Offset<rlogic_serialization::DataArray> resolveDataArrayOffset(sceneObjectId_t dataArrayId) const
        {
    ...
    private:
        ...
        std::unordered_map<sceneObjectId_t, flatbuffers::Offset<rlogic_serialization::DataArray>> m_dataArrays;
