...
{
    template <typename T>
    DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<T>&& data, std::string_view name, sceneObjectId_t id)
    ...
    bool checkFlatbufferVectorValidity(const rlogic_serialization::DataArray& data, ErrorReporting& errorReporting, uint32_t numComponents)
    {
        ...
        {
            errorReporting.set("Fatal error during loading of DataArray from serialized data: unexpected data type!", nullptr);
            return false;
        }
        ...
        {
            errorReporting.set("Fatal error during loading of DataArray from serialized data: unexpected data size!", nullptr);
            return false;
        }
    ...
    std::unique_ptr<DataArrayImpl> DataArrayImpl::Deserialize(const rlogic_serialization::DataArray& data, ErrorReporting& errorReporting, DeserializationMap& deserializationMap)
    {
        std::string name;
        sceneObjectId_t id{};
        ...
        {
            errorReporting.set("Fatal error during loading of DataArray from serialized data: missing name and/or ID!", nullptr);
            return nullptr;
        }
        ...
        case rlogic_serialization::EDataArrayType::Float:
        {
            ...
            deserialized = std::make_unique<DataArrayImpl>(deserializationMap.getScene(), std::move(dataVec), name, id);
            break;
        }
        case rlogic_serialization::EDataArrayType::Vec2f:
        {
            ...
            return std::make_unique<DataArrayImpl>(deserializationMap.getScene(), std::move(dataVec), name, id);
        }
        ...
        default:
            errorReporting.set(fmt::format("Fatal error during loading of DataArray from serialized data: unsupported or corrupt data type '{}'!", fmt::underlying(data.type())), nullptr);
            return nullptr;
        }
    ...
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<float>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec2f>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec3f>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec4f>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<int32_t>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec2i>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec3i>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<vec4i>&& data, std::string_view name, sceneObjectId_t id);
    template DataArrayImpl::DataArrayImpl(SceneImpl& scene, std::vector<std::vector<float>>&& data, std::string_view name, sceneObjectId_t id);
