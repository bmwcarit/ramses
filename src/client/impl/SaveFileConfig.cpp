...
namespace ramses
{
    ...
    void SaveFileConfig::setCompressionEnabled(bool compressionEnabled)
    {
        m_impl->setCompressionEnabled(compressionEnabled);
    }

    internal::SaveFileConfigImpl& SaveFileConfig::impl()
    {
        return *m_impl;
    }

    const internal::SaveFileConfigImpl& SaveFileConfig::impl() const
    {
        return *m_impl;
    }
}
