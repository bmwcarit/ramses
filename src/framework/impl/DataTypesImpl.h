...
template <> struct fmt::formatter<glm::vec4> : public ramses::internal::SimpleFormatterBase
{
...
template <> struct fmt::formatter<glm::vec3> : public ramses::internal::SimpleFormatterBase
{
...
template <> struct fmt::formatter<glm::vec2> : public ramses::internal::SimpleFormatterBase
{
...
template <> struct fmt::formatter<glm::ivec4> : public ramses::internal::SimpleFormatterBase
{
...
template <> struct fmt::formatter<glm::ivec3> : public ramses::internal::SimpleFormatterBase
{
...
template <> struct fmt::formatter<glm::ivec2> : public ramses::internal::SimpleFormatterBase
{
