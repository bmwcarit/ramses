...
#define FORWARD_DECLARE_CLASS(_className) \
    class _className; // NOLINT(bugprone-macro-parentheses)
...
#define DEFINE_RAMSES_OBJECT_TRAITS_NAMESPACE(_className, _id, _namespace, _baseTypeId, _isConcreteType) \
    ...
    DEFINE_RAMSES_OBJECT_TRAITS(LogicEngine, ERamsesObjectType::LogicEngine, ERamsesObjectType::SceneObject, true);
    DEFINE_RAMSES_OBJECT_TRAITS(LogicObject, ERamsesObjectType::LogicObject, ERamsesObjectType::SceneObject, false);
    ...
    DEFINE_RAMSES_OBJECT_TRAITS(Geometry, ERamsesObjectType::Geometry, ERamsesObjectType::SceneObject, true);
    ...
    DEFINE_RAMSES_OBJECT_TRAITS(ArrayBuffer, ERamsesObjectType::ArrayBuffer, ERamsesObjectType::SceneObject, true);
...
#define DEFINE_RAMSES_OBJECT_TRAITS_LIST_END() \
    ...
    DEFINE_RAMSES_OBJECT_TRAITS_LIST_BEGIN()
        ...
        DEFINE_RAMSES_OBJECT_TRAITS_LIST(ERamsesObjectType::LogicEngine)
        DEFINE_RAMSES_OBJECT_TRAITS_LIST(ERamsesObjectType::LogicObject)
        ...
        DEFINE_RAMSES_OBJECT_TRAITS_LIST(ERamsesObjectType::ArrayBuffer)
    ...
    const size_t RamsesObjectTypeCount = static_cast<size_t>(ERamsesObjectType::TextureSamplerExternal) + 1u;
    ...
    static_assert(RamsesObjectTypeCount == RamsesObjectTraits.size(), "Every RamsesObject type must register its traits!");
    static_assert(ramses::internal::EnumTraits::VerifyElementCountIfSupported<ERamsesObjectType>(RamsesObjectTypeCount));
}
