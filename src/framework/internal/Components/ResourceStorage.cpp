...
namespace ramses::internal
{
    ...
    ManagedResource ResourceStorage::getResource(ResourceContentHash hash)
    {
        PlatformGuard lock(m_resourceMapLock);
    ...
    ResourceHashUsage ResourceStorage::getResourceHashUsage(const ResourceContentHash& hash)
    {
    ...
    ManagedResource ResourceStorage::manageResource(const IResource& resource, bool deletionAllowed)
    {
        ResourceDeleterCallingCallback deleter(*this);
