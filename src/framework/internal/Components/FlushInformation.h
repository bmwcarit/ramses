...
template <>
struct fmt::formatter<ramses::internal::FlushInformation> : public ramses::internal::SimpleFormatterBase
{
    template<typename FormatContext>
    constexpr auto format(const ramses::internal::FlushInformation& fi, FormatContext& ctx)
    {
        fmt::format_to(ctx.out(),
            ...
            fmt::underlying(fi.flushTimeInfo.clock_type),
