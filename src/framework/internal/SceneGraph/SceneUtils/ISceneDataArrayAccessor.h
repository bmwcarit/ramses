...
namespace ramses::internal
{
    ...
    public:
        ...
        template <typename T>
        static void SetDataArray(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const T* data);
    };
    ...
    template <>
    inline const bool* ISceneDataArrayAccessor::GetDataArray<bool>(const IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field)
    {
        return scene->getDataBooleanArray(containerHandle, field);
    }

    template <>
    inline const int32_t* ISceneDataArrayAccessor::GetDataArray<int32_t>(const IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field)
    {
    ...
    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<float>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const float* data)
    {
        scene->setDataFloatArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::vec2>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::vec2* data)
    {
        scene->setDataVector2fArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::vec3>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::vec3* data)
    {
        scene->setDataVector3fArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::vec4>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::vec4* data)
    {
        scene->setDataVector4fArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<bool>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const bool* data)
    {
        scene->setDataBooleanArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<int32_t>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const int32_t* data)
    {
        scene->setDataIntegerArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::ivec2>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::ivec2* data)
    {
        scene->setDataVector2iArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::ivec3>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::ivec3* data)
    {
        scene->setDataVector3iArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::ivec4>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::ivec4* data)
    {
        scene->setDataVector4iArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::mat2>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::mat2* data)
    {
        scene->setDataMatrix22fArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::mat3>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::mat3* data)
    {
        scene->setDataMatrix33fArray(containerHandle, field, elementCount, data);
    }

    template <>
    inline void ISceneDataArrayAccessor::SetDataArray<glm::mat4>(IScene* scene, DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const glm::mat4* data)
    {
