...
namespace ramses::internal
{
    ...
    public:
        ...
        void setDataBooleanArray(DataInstanceHandle containerHandle, DataFieldHandle field, uint32_t elementCount, const bool* data);
        ...
        void setRenderPassClearFlag(RenderPassHandle passHandle, ClearFlags clearFlag);
        ...
        void updateTextureBuffer(TextureBufferHandle handle, uint32_t mipLevel, uint32_t x, uint32_t y, uint32_t width, uint32_t height, const std::byte* data, uint32_t dataSize);
