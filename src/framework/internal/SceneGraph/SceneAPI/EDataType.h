...
WARNINGS_POP
    ...
    inline constexpr uint32_t EnumToSize(EDataType type)
    {
        switch (type)
        {
        case EDataType::Bool             : return sizeof(bool);
    ...
    inline size_t EnumToAlignment(EDataType type)
    {
        switch (type)
        {
        case EDataType::Bool             : return alignof(bool);
    ...
    template <>
    struct TypeToEDataTypeTraits < bool >
    {
        static const EDataType DataType = EDataType::Bool;
    };
