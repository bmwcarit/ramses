...
namespace ramses::internal
{
    namespace {
        struct HandlerInfo
        {
            PlatformSignal::SignalHandlerFunction handler{nullptr};
            PlatformSignal::SignalHandlerFunction previousHandler{nullptr};
            bool chainPrevious{false};
            bool active{false};
        };
        ...
        {
            auto enumSig = static_cast<ESignal>(sig);
            HandlerInfo info;
