...
#include "internal/Ramsh/RamshCommandArgumentsDataProvider.h"
#include "internal/Ramsh/RamshCommandArgumentsUtils.h"
...
namespace ramses::internal
{
    ...
    public:
        ...
        ~RamshCommandArgsBase() override = default;
    ...
    protected:
        ...
        bool executeInternal(const RamshArgumentDataProvider& args,T1& a1,T2& a2,T3& a3,T4& a4,Unused& unused) const override;
...
#undef ECHO_CLASS
    ...
    template<int32_t N, typename T0,typename T1,typename T2, typename T3, typename T4>
    inline bool RamshCommandArgsBase<N,T0,T1,T2,T3,T4>::executeInternal(const RamshArgumentDataProvider& args,T1& a1,T2& a2,T3& a3,T4& a4,Unused& /*unused*/) const
    {
        T0 val;
    ...
    template<int32_t N>
    inline RamshCommandArgsBase<N, Unused, Unused, Unused, Unused, Unused>::RamshCommandArgsBase() = default;
