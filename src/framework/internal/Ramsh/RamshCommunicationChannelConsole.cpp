...
namespace ramses::internal
{
    ...
    RamshCommunicationChannelConsole::RamshCommunicationChannelConsole(Ramsh& ramsh, std::string prompt, std::unique_ptr<ConsoleInput> consoleInput, bool startThread)
        : m_ramsh(ramsh)
