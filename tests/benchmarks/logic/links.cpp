...
namespace ramses
{
    static void BM_Links_CreateDestroyLink(benchmark::State& state)
    {
        ...
        Property* from = srcScript->getOutputs()->getChild("src0");
    ...
    static void BM_Links_CreateDestroyLink_ManyScripts(benchmark::State& state)
    {
        ...
        Property* srcPropertyInTheMiddle  = scripts[halfwayIndex]->getOutputs()->getChild("src10");
        Property* destPropertyInTheMiddle = scripts[halfwayIndex+1]->getInputs()->getChild("dest10");
