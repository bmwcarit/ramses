...
namespace ramses::internal
{
    ...
    protected:
        ...
        static AssertionResult CheckOrder(SceneGraphIterator& iterator, const std::vector<Node*>& expectedOrder)
        {
    ...
    {
        SceneGraphIterator iterator(m_root, ETreeTraversalStyle::DepthFirst);
    ...
    {
        SceneGraphIterator iterator(m_root, ETreeTraversalStyle::BreadthFirst);
    ...
    {
        SceneGraphIterator iter(m_mesh1b, ETreeTraversalStyle::DepthFirst);
    ...
    {
        SceneGraphIterator iter(m_mesh1b, ETreeTraversalStyle::BreadthFirst);
        EXPECT_EQ(&m_mesh1b, iter.getNext());
        EXPECT_EQ(nullptr, iter.getNext());
    }
}
