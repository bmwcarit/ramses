...
namespace ramses::internal
{
    ...
    public:
        ...
        static Effect* createEffect(ramses::Scene& scene, bool withSemantics, bool withGeometryShader = false)
        {
            ...
            if (withSemantics)
            {
                ...
                effectDesc.setUniformSemantic("matrix44fInput", EEffectUniformSemantic::ModelViewMatrix);
                effectDesc.setUniformSemantic("texture2dInput", EEffectUniformSemantic::TextTexture);
            }

            return scene.createEffect(effectDesc, "input test effect");
        }
