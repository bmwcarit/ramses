...
#include "internal/logic/DirectedAcyclicGraph.h"
...
{
    class ADirectedAcyclicGraph : public ALogicEngine
    {
    protected:
        DirectedAcyclicGraph m_graph;

        std::array<LogicNodeImpl*, 6> m_testNodes
        {
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "1")->impl(),
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "2")->impl(),
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "3")->impl(),
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "4")->impl(),
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "5")->impl(),
            &m_logicEngine->createLuaScript(m_valid_empty_script, {}, "6")->impl()
        };

        // For easier access in the tests
        LogicNodeImpl& N1 { *m_testNodes[0] };
        LogicNodeImpl& N2 { *m_testNodes[1] };
        LogicNodeImpl& N3 { *m_testNodes[2] };
        LogicNodeImpl& N4 { *m_testNodes[3] };
        LogicNodeImpl& N5 { *m_testNodes[4] };
        LogicNodeImpl& N6 { *m_testNodes[5] };
