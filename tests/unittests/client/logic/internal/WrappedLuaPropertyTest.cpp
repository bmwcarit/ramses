...
namespace ramses::internal
{
    ...
    protected:
        ...
        void setDummyDataRecursively(PropertyImpl& prop)
        {
            ...
            case EPropertyType::Struct:
                ...
                {
                    setDummyDataRecursively(prop.getChild(i)->impl());
                }
                break;
            }
        }
        ...
        sol::state m_sol;
        ScopedLogContextLevel m_silenceLogs = ScopedLogContextLevel{CONTEXT_CLIENT, ELogLevel::Off};
    };
    ...
    TEST_F(AWrappedLuaProperty_Access, ResolvesArrayElements)
    {
        for (auto semantics : std::vector<EPropertySemantics>{ EPropertySemantics::ScriptInput, EPropertySemantics::ScriptOutput })
        {
            ...
            nestedArray.getChild("array")->getChild(1)->impl().setValue(vec3f{15, 16, 17});
