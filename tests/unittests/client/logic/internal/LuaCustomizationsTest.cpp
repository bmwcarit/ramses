...
#include "internal/logic/LuaCustomizations.h"
...
namespace ramses::internal
{
    ...
    class TheLuaCustomizations: public ::testing::Test
    {
        protected:
            TheLuaCustomizations()
            {
                ...
                m_structProp.getChild("field1")->impl().setValue(5);
                m_structProp.getChild("field2")->impl().setValue(6);

                m_arrayProp.getChild(0)->impl().setValue(11);
                m_arrayProp.getChild(1)->impl().setValue(12);
                m_arrayProp.getChild(2)->impl().setValue(13);
            }
    ...
    TEST_F(TheLuaCustomizations_Next, WorksForWriteProtectedModules)
    {
        ...
        ASSERT_FALSE(errors.getError().has_value());
