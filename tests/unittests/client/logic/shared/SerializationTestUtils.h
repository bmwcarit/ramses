...
namespace ramses::internal
{
    ...
    public:
        ...
        flatbuffers::Offset<rlogic_serialization::RenderPassBinding> serializeTestRenderPassBindingWithError()
        {
            return rlogic_serialization::CreateRenderPassBinding(
                m_builder,
                0 // no base -> causes errors
            );
        }

        flatbuffers::Offset<rlogic_serialization::RenderGroupBinding> serializeTestRenderGroupBindingWithError()
        {
