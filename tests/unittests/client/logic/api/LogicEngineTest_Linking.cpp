...
namespace ramses::internal
{
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfPropertiesWithMismatchedTypesAreLinked)
    {
        ...
        for (const auto& errorCase : errorCases)
        {
            ...
            EXPECT_EQ(getLastErrorMessage(), std::get<2>(errorCase));
        }
    }

    TEST_F(ALogicEngine_Linking, ProducesErrorIfLogicNodeIsLinkedToItself)
    {
        auto targetPropertyFromTheSameScript = m_sourceScript.getInputs()->getChild("target");

        EXPECT_FALSE(m_logicEngine->link(m_sourceProperty, *targetPropertyFromTheSameScript));

        EXPECT_EQ(getLastErrorMessage(), "Link source and target can't belong to the same node! ('SourceScript')");
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfInputIsLinkedToOutput)
    {
        ...
        EXPECT_EQ("Failed to link input property 'target' to output property 'source'. Only outputs can be linked to inputs", getLastErrorMessage());
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfInputIsLinkedToInput)
    {
        ...
        EXPECT_EQ("Failed to link input property 'target' to input property 'target'. Only outputs can be linked to inputs", getLastErrorMessage());
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfOutputIsLinkedToOutput)
    {
        ...
        EXPECT_EQ("Failed to link output property 'source_int' to output property 'source_int'. Only outputs can be linked to inputs", getLastErrorMessage());
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfPropertyIsLinkedTwiceToSameProperty_LuaScript)
    {
        ...
        EXPECT_EQ(getLastErrorMessage(), "The property 'target' of LogicNode 'TargetScript' is already linked (to property 'source' of LogicNode 'SourceScript')");
    }

    TEST_F(ALogicEngine_Linking, ProducesErrorIfPropertyIsLinkedTwice_RamsesBinding)
    {
        auto ramsesBinding = m_logicEngine->createNodeBinding(*m_node, ramses::ERotationType::Euler_XYZ, "RamsesBinding");
        ...
        EXPECT_EQ(getLastErrorMessage(), "The property 'visibility' of LogicNode 'RamsesBinding' is already linked (to property 'source' of LogicNode 'SourceScript')");
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfNotLinkedPropertyIsUnlinked_LuaScript)
    {
        ...
        EXPECT_EQ(getLastErrorMessage(), "Input property 'target' is not currently linked!");
    }

    TEST_F(ALogicEngine_Linking, ProducesErrorIfNotLinkedPropertyIsUnlinked_NodeBinding)
    {
        auto ramsesBinding = m_logicEngine->createNodeBinding(*m_node, ramses::ERotationType::Euler_XYZ, "RamsesBinding");
        ...
        EXPECT_EQ(getLastErrorMessage(), "Input property 'visibility' is not currently linked!");
    }
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorOnNextUpdateIfLinkCycleWasCreated)
    {
        ...
        Property* sourceInput = m_sourceScript.getInputs()->getChild("target");
        Property* sourceOutput = m_sourceScript.getOutputs()->getChild("source");
        Property* targetInput = m_targetScript.getInputs()->getChild("target");
        Property* targetOutput = m_targetScript.getOutputs()->getChild("source");
        Property* loopInput = loopScript.getInputs()->getChild("target");
        Property* loopOutput = loopScript.getOutputs()->getChild("source");
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorOnLinkingStructs)
    {
        ...
        EXPECT_EQ("Can't link properties of complex types directly, currently only primitive properties can be linked", getLastErrorMessage());
    ...
    TEST_F(ALogicEngine_Linking, ProducesErrorIfNotLinkedPropertyIsUnlinked_WhenAnotherLinkFromTheSameScriptExists)
    {
        ...
        EXPECT_EQ(getLastErrorMessage(), "Input property 'intTarget2' is not currently linked!");
    }

    TEST_F(ALogicEngine_Linking, ProducesErrorIfNotLinkedPropertyIsUnlinked_RamsesBinding)
    {
        auto targetBinding = m_logicEngine->createNodeBinding(*m_node, ramses::ERotationType::Euler_XYZ, "NodeBinding");
        ...
        EXPECT_EQ(getLastErrorMessage(), "Input property 'translation' is not currently linked!");
    }
    ...
    TEST_F(ALogicEngine_Linking, PropagatesOutputsToInputsIfLinkedForAppearanceBindings)
    {
        ...
        auto sourceScript  = m_logicEngine->createLuaScript(luaScriptSource);
        auto targetBinding = m_logicEngine->createAppearanceBinding(*m_appearance, "TargetBinding");
    ...
    TEST_F(ALogicEngine_Linking, PropagatesOutputsToInputsIfLinkedForCameraBindings)
    {
        const auto  luaScriptSource = R"(
            function interface(IN,OUT)
                IN.floatInput = Type:Float()
        ...
        auto sourceScript = m_logicEngine->createLuaScript(luaScriptSource);
        auto targetBinding = m_logicEngine->createCameraBinding(*m_camera, "TargetBinding");
    ...
    TEST_F(ALogicEngine_Linking, PropagatesOutputsToInputsIfLinkedForRenderPassBindings)
    {
        const auto luaScriptSource = R"(
            function interface(IN,OUT)
                IN.val = Type:Int32()
        ...
        auto sourceScript = m_logicEngine->createLuaScript(luaScriptSource);
        auto targetBinding = m_logicEngine->createRenderPassBinding(*m_renderPass, "TargetBinding");
    ...
    TEST_F(ALogicEngine_Linking, PropagatesOutputsToInputsIfLinkedForRenderGroupBindings)
    {
        const auto luaScriptSource = R"(
            function interface(IN,OUT)
                IN.val = Type:Int32()
    ...
    {
        LogicEngine& otherLogicEngine = *m_scene->createLogicEngine();
        const auto  luaScriptSource = R"(
            function interface(IN,OUT)
                IN.floatInput = Type:Float()
                OUT.floatOutput = Type:Float()
        ...
        {
            EXPECT_EQ("LogicNode 'TargetScript' is not an instance of this LogicEngine", getLastErrorMessage());
        }

        EXPECT_FALSE(otherLogicEngine.link(*sourceOutput, *targetInput));
        {
            EXPECT_EQ("LogicNode 'SourceScript' is not an instance of this LogicEngine", getLastErrorMessage());
        }
    }
    ...
    {
        NodeBinding& nodeBinding = *m_logicEngine->createNodeBinding(*m_node, ramses::ERotationType::Euler_XYZ, "");
        ...
        Property* nodeTranslation = nodeBinding.getInputs()->getChild("translation");
        Property* scriptOutVec3f = outScript->getOutputs()->getChild("out_vec3f");
        ...
        EXPECT_FALSE(m_logicEngine->impl().getApiObjects().getLogicNodeDependencies().isLinked(nodeBinding.impl()));
        EXPECT_FALSE(m_logicEngine->impl().getApiObjects().getLogicNodeDependencies().isLinked(outScript->impl()));
        EXPECT_FALSE(m_logicEngine->impl().getApiObjects().getLogicNodeDependencies().isLinked(nodeBinding.impl()));
        EXPECT_FALSE(m_logicEngine->impl().getApiObjects().getLogicNodeDependencies().isLinked(outScript->impl()));
        EXPECT_FALSE(m_logicEngine->impl().isLinked(*outScript));
        EXPECT_FALSE(m_logicEngine->impl().isLinked(nodeBinding));
    ...
    TEST_F(ALogicEngine_Linking, WHEN_ScriptWasUnlinkedFromBindingAndMultipleLinksDestroyed_THEN_UpdateDoesNotOverwriteBindingInputsByDanglingLinks)
    {
        ...
        Property* nodeTranslation = nodeBinding.getInputs()->getChild("translation");
        Property* nodeVisibility = nodeBinding.getInputs()->getChild("visibility");
        Property* scriptTranslation = outScript->getOutputs()->getChild("translation");
        Property* scriptVisiblity = outScript->getOutputs()->getChild("visibility");
    ...
    TEST_F(ALogicEngine_Linking_WithFiles, PreservesLinksBetweenScriptsAfterSavingAndLoading)
    {
        ...
        {
            ASSERT_TRUE(recreateFromFile("links.bin"));

            // Load all scripts and their properties
            auto scriptC = m_logicEngine->findObject<LuaScript>("ScriptC");
            auto scriptB = m_logicEngine->findObject<LuaScript>("ScriptB");
            auto scriptA = m_logicEngine->findObject<LuaScript>("ScriptA");
    ...
    TEST_F(ALogicEngine_Linking_WithFiles, PreservesNestedLinksBetweenScriptsAfterSavingAndLoading)
    {
        ...
        {
            ASSERT_TRUE(recreateFromFile("nested_links.bin"));
    ...
    TEST_F(ALogicEngine_Linking_WithFiles, PropagatesValuesInACycleAcrossMultipleLinksAndWeakLinkAfterSavingAndLoading)
    {
        ...
        const auto script3 = m_logicEngine->findObject<LuaScript>("scriptC");
    ...
    protected:
        ...
        static void ExpectVec3f(ramses::Appearance& appearance, const char* uniformName, vec3f expectedValue)
        {
            ...
            const auto uniform = appearance.getEffect().findUniformInput(uniformName);
        ...
        ramses::Appearance& createTestAppearance(ramses::Effect& effect, std::string_view name = {})
        {
    ...
    {
        {
            auto ramsesNode1 = m_scene->createNode("node01");
            auto ramsesNode2 = m_scene->createNode("node02");
            ...
            auto nodeBinding1 = tmpLogicEngine.createNodeBinding(*ramsesNode1, ramses::ERotationType::Euler_XYZ, "NodeBinding1");
            auto nodeBinding2 = tmpLogicEngine.createNodeBinding(*ramsesNode2, ramses::ERotationType::Euler_XYZ, "NodeBinding2");
...

        {
            ...
            auto ramsesNode1 = m_scene->findObject<Node>("node01");
            auto ramsesNode2 = m_scene->findObject<Node>("node02");
            ...
            ramsesNode1->setRotation({0.0f, 0.0f, 0.0f}, ERotationType::Euler_XYZ);
            ...
            auto nodeBinding1 = m_logicEngine->findObject<NodeBinding>("NodeBinding1");
            auto nodeBinding2 = m_logicEngine->findObject<NodeBinding>("NodeBinding2");
            ...
            binding1TranslationInput->impl().setValue(vec3f{ 99.0f, 99.0f, 99.0f });
            binding2RotationInput->impl().setValue(vec3f{ 99.0f, 99.0f, 99.0f });
            bindingVisibilityInput->impl().setValue(true);
    ...
    {
        {
            ...
            auto& appearance1 = createTestAppearance(effect, "appearance01");
            auto& appearance2 = createTestAppearance(effect, "appearance02");
            const auto uniform1 = appearance1.getEffect().findUniformInput("uniform1");
            const auto uniform2 = appearance1.getEffect().findUniformInput("uniform2");
            ASSERT_TRUE(uniform1.has_value() && uniform2.has_value());
            ...
            auto script = tmpLogicEngine.createLuaScript(scriptSrc);
            auto appBinding1 = tmpLogicEngine.createAppearanceBinding(appearance1, "AppBinding1");
            auto appBinding2 = tmpLogicEngine.createAppearanceBinding(appearance2, "AppBinding2");
...

        {
            ...
            auto& appearance1 = *m_scene->findObject<Appearance>("appearance01");
            auto& appearance2 = *m_scene->findObject<Appearance>("appearance02");
            const auto uniform1 = appearance1.getEffect().findUniformInput("uniform1");
            const auto uniform2 = appearance1.getEffect().findUniformInput("uniform2");
            ...
            auto appBinding1 = m_logicEngine->findObject<AppearanceBinding>("AppBinding1");
            auto appBinding2 = m_logicEngine->findObject<AppearanceBinding>("AppBinding2");
            ...
            // These values should be overwritten by the link - set them to a different value to make sure that happens
            binding1uniform1->impl().setValue(vec3f{ 99.0f, 99.0f, 99.0f });
            ...
            // These values should be overwritten by the link - set them to a different value to make sure that happens
            binding2uniform1->impl().setValue(vec3f{ 99.0f, 99.0f, 99.0f });
            binding2uniform2->impl().setValue(vec3f{ 99.0f, 99.0f, 99.0f });
            EXPECT_TRUE(m_logicEngine->update());
    ...
    {
        {
            auto camera1 = m_scene->createPerspectiveCamera("camera01");
            auto camera2 = m_scene->createPerspectiveCamera("camera02");
            ...
            auto script = tmpLogicEngine.createLuaScript(scriptSrc);
            auto cameraBinding1 = tmpLogicEngine.createCameraBinding(*camera1, "CameraBinding1");
            auto cameraBinding2 = tmpLogicEngine.createCameraBinding(*camera2, "CameraBinding2");
        ...
        {
            ASSERT_TRUE(recreateFromFile("binding_links.bin"));
            auto camera1 = m_scene->findObject<PerspectiveCamera>("camera01");
            auto camera2 = m_scene->findObject<PerspectiveCamera>("camera02");
            ...
            auto cameraBinding1 = m_logicEngine->findObject<CameraBinding>("CameraBinding1");
            auto cameraBinding2 = m_logicEngine->findObject<CameraBinding>("CameraBinding2");
            ...
            // These values should be overwritten by the link - set them to a different value to make sure that happens
            binding1cameraProperty1->impl().setValue(100);
            // This should not be overwritten, but should keep the manual value instead, because no link points to it
            ASSERT_TRUE(binding1cameraProperty2->set<float>(100.f));
            // These values should be overwritten by the link - set them to a different value to make sure that happens
            binding2cameraProperty1->impl().setValue(100);
            binding2cameraProperty2->impl().setValue(100.f);
            EXPECT_TRUE(m_logicEngine->update());
    ...
    {
        {
            auto rp1 = m_scene->createRenderPass("rp01");
            auto rp2 = m_scene->createRenderPass("rp02");
            ...
            auto script = tmpLogicEngine.createLuaScript(scriptSrc);
            auto binding1 = tmpLogicEngine.createRenderPassBinding(*rp1, "RPBinding1");
            auto binding2 = tmpLogicEngine.createRenderPassBinding(*rp2, "RPBinding2");
        ...
        }
        {
            ...
            auto rp1 = m_scene->findObject<RenderPass>("rp01");
            auto rp2 = m_scene->findObject<RenderPass>("rp02");
            ...
            auto binding1 = m_logicEngine->findObject<RenderPassBinding>("RPBinding1");
            auto binding2 = m_logicEngine->findObject<RenderPassBinding>("RPBinding2");
            ...
            // These values should be overwritten by the link - set them to a different value to make sure that happens
            binding2Property1->impl().setValue(false);
            binding2Property2->impl().setValue(100);
            EXPECT_TRUE(m_logicEngine->update());
    ...
    TEST_F(ALogicEngine_Linking_WithBindings, PreservesLinksToRenderGroupBindingsAfterSavingAndLoadingFromFile)
    {
...

        {
            ...
            auto binding = tmpLogicEngine.createRenderGroupBinding(*m_renderGroup, elements, "binding");
        ...
        {
            ASSERT_TRUE(recreateFromFile("binding_links.bin"));
            ASSERT_TRUE(m_renderGroup != nullptr);
            ASSERT_TRUE(m_meshNode != nullptr);
    ...
    TEST_F(ALogicEngine_Linking, SetsAffectedNodesToDirtyAfterLinking)
    {
        ...
        auto sourceScript  = m_logicEngine->createLuaScript(scriptSource);
        auto targetBinding = m_logicEngine->createNodeBinding(*m_node, ramses::ERotationType::Euler_XYZ, "RamsesBinding");

        m_logicEngine->update();

        EXPECT_FALSE(sourceScript->impl().isDirty());
        EXPECT_FALSE(targetBinding->impl().isDirty());
        ...
        EXPECT_TRUE(targetBinding->impl().isDirty());
    }
    ...
    TEST_F(ALogicEngine_Linking_Confidence, CanDestroyLinkedScriptsWithComplexTypes_WithLinkStillActive_DestroySourceFirst)
    {
        ...
        Property& sourceVec(*sourceScript.getOutputs()->getChild("struct")->getChild("nested")->getChild("vec3f"));
    ...
    TEST_F(ALogicEngine_Linking_Confidence, CanDestroyLinkedScriptsWithComplexTypes_WithLinkStillActive_ArrayOfStructs)
    {
        ...
        Property& sourceVec(*sourceScript.getOutputs()->getChild("array")->getChild(0)->getChild("vec3f"));
        Property& targetVec(*targetScript.getInputs()->getChild("struct")->getChild("nested")->getChild("vec3f"));
    ...
    TEST_F(ALogicEngine_Linking_Confidence, CanDestroyLinkedBinding_WithNestedLinkStillActive)
    {
        ...
        Property& sourceVec(*sourceScript.getOutputs()->getChild("struct")->getChild(0)->getChild("vec3f"));
