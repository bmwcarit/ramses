...
namespace ramses::internal
{
    ...
    TEST_F(ALuaScript_Interface, ProducesErrorsIfARuntimeErrorOccursInInterface)
    {
        ...
        EXPECT_THAT(getLastErrorMessage(), ::testing::AllOf(
    ...
    TEST_F(ALuaScript_Interface, ReportsError_WhenDeclaredStructWithExplicitTypeWithoutArgument)
    {
        ...
        LuaScript* script = m_logicEngine->createLuaScript(explicitStructSyntax);
        ASSERT_EQ(nullptr, script);
        EXPECT_THAT(getLastErrorMessage(), ::testing::HasSubstr("Type:Struct(T) invoked with invalid type parameter T!"));
    }
    ...
    TEST_F(ALuaScript_Interface, MarksInputsAsInput)
    {
        ...
        {
            EXPECT_EQ(internal::EPropertySemantics::ScriptInput, inputs->getChild(i)->impl().getPropertySemantics());
        }
    }
    ...
    TEST_F(ALuaScript_Interface, MarksOutputsAsOutput)
    {
        ...
        {
            EXPECT_EQ(internal::EPropertySemantics::ScriptOutput, outputs->getChild(i)->impl().getPropertySemantics());
        }
    }
    ...
    TEST_F(ALuaScript_Interface, ReportsErrorWhenAccessingStructByIndex)
    {
        ...
        ASSERT_EQ(nullptr, script);
        EXPECT_THAT(getLastErrorMessage(), ::testing::HasSubstr("lua: error: Bad index access to struct 'struct': Expected a string but got object of type number instead!"));
    }
    ...
    TEST_F(ALuaScript_Interface, ReportsErrorWhenAccessingArrayByString)
    {
        ...
        ASSERT_EQ(nullptr, script);
        EXPECT_THAT(getLastErrorMessage(), ::testing::HasSubstr("lua: error: Invalid index access in array 'array_int'"));
    }
    ...
    TEST_F(ALuaScript_Interface, ReportsErrorWhenAccessingArrayWithIndexOverflow)
    {
        ...
        ASSERT_EQ(nullptr, script);
        EXPECT_THAT(getLastErrorMessage(), ::testing::HasSubstr("Invalid index access in array 'array_int'. Expected index in the range [0, 2] but got 3 instead!"));
    }
