...
namespace ramses::internal
{
    ...
    {
        const SceneInfo sceneInfo{ sceneId, sceneName, EScenePublicationMode::LocalAndRemote };
        fixture.handleNewSceneAvailable(sceneInfo, providerID);
    ...
    TEST_F(ARendererFrameworkLogic, handlesSceneUpdateWithFlush)
    {
        ...
        EXPECT_CALL(cmdVisitor, handleSceneUpdate(sceneId, _)).WillOnce(Invoke([&](auto /*unused*/, const SceneUpdate& data)
        {
