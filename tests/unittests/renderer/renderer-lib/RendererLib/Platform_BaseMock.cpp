...
namespace ramses::internal
{
        ...
        : Platform_Base(config)
    {
        ...
        ON_CALL(*this, createContext(_)).WillByDefault(Invoke([this](auto& /*unused*/) {
            assert(!m_context);
        ...
        ON_CALL(*this, createEmbeddedCompositor(_)).WillByDefault(Invoke([this](auto& /*unused*/) {
        ...
        ON_CALL(*this, createTextureUploadingAdapter(_)).WillByDefault(Invoke([this](auto& /*unused*/) {
