...
namespace ramses::internal
{
    ...
    public:
        ...
        static void ExpectEvents(const RendererEventVector& expectedEvts, const RendererEventVector& evts)
        {
    ...
    TEST_F(ADisplayDispatcher, pushesCommandToItsDestinationDisplay)
    {
        ...
        m_commandBuffer.enqueueCommand(RendererCommand::CreateOffscreenBuffer{ display1, {}, {}, {}, {}, {}, EDepthBufferType::DepthStencil });
    ...
    TEST_F(ADisplayDispatcher, consolidatesBroadcastCommandBeforePushingToNewlyCreatedDisplay)
    {
        ...
        m_displayDispatcher.m_expectedBroadcastCommandsForNewDisplays.push_back(RendererCommand::ScenePublished{ scene3, EScenePublicationMode::LocalOnly });
    ...
    TEST_F(ADisplayDispatcher, willGenerateFailEventIfPushingCommandForUnknownDisplay)
    {
        ...
        m_commandBuffer.enqueueCommand(RendererCommand::DestroyOffscreenBuffer{ display2, {} });
        m_commandBuffer.enqueueCommand(RendererCommand::CreateOffscreenBuffer{ display2, {}, {}, {}, {}, {}, EDepthBufferType::DepthStencil });
