...
namespace ramses::internal
{
    ...
    public:
        ...
        void SetUp() override
        {
            ...
            EXPECT_CALL(m_sceneLogic, getSceneInfo(_, _, _, _)).WillRepeatedly([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; });
        }
    ...
    TEST_F(ASceneReferenceLogic, requestsStateChangeForReferencedScene)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/)
        {
    ...
    TEST_F(ASceneReferenceLogic, reactsToMasterSceneStateChangeSoThatReferencedScenesNeverHaveHigherStateThanMaster_fromAvailableUp)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; }));
        ...
        // next query ref scenes will report their requested states
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
    ...
    TEST_F(ASceneReferenceLogic, reactsToMasterSceneStateChangeSoThatReferencedScenesNeverHaveHigherStateThanMaster_fromRenderedDown)
    {
        ...
        // next query ref scenes will report their requested states
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Rendered; }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillOnce(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
    ...
    TEST_F(ASceneReferenceLogic, referencedScenesInheritAssignmentInformationFromMasterScene)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillOnce(Invoke([&](auto /*unused*/, auto& /*unused*/, auto& ob_, auto& renderOrder)
        {
            ob_ = ob;
            renderOrder = -13;
        }));
    ...
    TEST_F(ASceneReferenceLogic, referencedScenesGetUpdatedBufferAssignmentFromMasterScene)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(_, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& state, auto& ob_, auto& renderOrder)
        {
    ...
    TEST_F(ASceneReferenceLogic, setsRenderOrderForReferencedScene)
    {
        ...
        {
            // simulate master scene has mapping set
            EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& /*unused*/, auto& ob_, auto& renderOrder)
            {
                ob_ = ob1;
                renderOrder = -13;
            }));
            ...
            EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& /*unused*/, auto& ob_, auto& renderOrder)
            {
                ob_ = ob1;
                renderOrder = -13;
            }));
            EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& /*unused*/, auto& ob_, auto& renderOrder)
            {
                ob_ = ob1;
                renderOrder = -13;
            }));
    ...
    TEST_F(ASceneReferenceLogic, requestsAvailableStateForAllReferencedScenesOfDestroyedMasterScene)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/)
        {
            targetState = RendererSceneState::Ready;
        }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId2, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/)
        {
            targetState = RendererSceneState::Ready;
        }));
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(_, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/)
        {
            targetState = RendererSceneState::Ready;
        }));
    ...
    {
        // simulate master scene Ready
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Ready; }));
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; }));
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId12, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; }));
    ...
    TEST_F(ASceneReferenceLogic, referenceCanBeControlledUnderNewMasterWhenRereferenced)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(_, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Available; }));
        ...
        m_scenes.getScene(MasterSceneId1).requestSceneReferenceState(RefSceneHandle11, RendererSceneState::Rendered);
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Rendered; }));
        m_logic.update();
    ...
    TEST_F(ASceneReferenceLogic, referenceCanBeControlledUnderNewMasterWhenRereferencedAfterOldMasterDestroyed)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId21, _, _, _)).WillRepeatedly(Invoke([](auto /*unused*/, auto& targetState, auto& /*unused*/, auto& /*unused*/) { targetState = RendererSceneState::Rendered; }));
        m_logic.update();
    ...
    TEST_F(ASceneReferenceLogic, referenceGetsAssignmentFromNewMasterWhenRereferenced)
    {
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId1, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& targetState, auto& ob, auto& renderOrder)
        {
            targetState = RendererSceneState::Rendered;
            ob = ob1;
        ...
        m_scenes.getScene(MasterSceneId1).requestSceneReferenceState(RefSceneHandle11, RendererSceneState::Rendered);
        EXPECT_CALL(m_sceneLogic, getSceneInfo(RefSceneId11, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& targetState, auto& ob, auto& renderOrder)
        {
            targetState = RendererSceneState::Rendered;
            ob = ob1;
            renderOrder = renderOrder1;
        ...
        EXPECT_CALL(m_sceneLogic, getSceneInfo(MasterSceneId2, _, _, _)).WillRepeatedly(Invoke([&](auto /*unused*/, auto& targetState, auto& ob, auto& renderOrder)
        {
            targetState = RendererSceneState::Rendered;
            ob = ob2;
