...
namespace ramses::internal{
    ...
    public:
        ...
        MOCK_METHOD(void, updateTextureBuffer, (TextureBufferHandle textureBufferHandle, uint32_t mipLevel, const Quad& area, uint32_t stride, const std::byte* data, SceneId sceneId), (override));
