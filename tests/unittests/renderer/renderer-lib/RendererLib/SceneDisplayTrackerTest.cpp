...
namespace ramses::internal
{
    ...
    TEST_F(ASceneDisplayTracker, determinesDisplayFromCommandOrFromOwnership)
    {
        ...
        EXPECT_EQ(cmdDisplay, tracker.determineDisplayFromRendererCommand(RendererCommand::CreateOffscreenBuffer{ cmdDisplay, {}, {}, {}, {}, {}, EDepthBufferType::DepthStencil }));
        ...
        // broadcast commands
        EXPECT_FALSE(tracker.determineDisplayFromRendererCommand(RendererCommand::ScenePublished{ sceneId, EScenePublicationMode::LocalOnly }));
