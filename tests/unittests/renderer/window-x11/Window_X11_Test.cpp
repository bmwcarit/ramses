...
namespace ramses::internal
{
    ...
    public:
        ...
        void testKeyCode(uint32_t virtualKeyCode, EKeyCode expectedRamesKeyCode, KeyModifiers expectedModifier = EKeyModifier::NoModifier)
        {
    ...
    TEST_F(WindowX11, singleKeyPressEventTriggersKeyPressedEventWithCorrectKeyCode)
    {
        ...
        testKeyCode(XK_Shift_L,  EKeyCode_ShiftLeft,     EKeyModifier::Shift);
    }
    ...
    TEST_F(WindowX11, positiveMouseWheelEventTriggersMouseWheelUpEvent)
    {
        ...
        EXPECT_CALL(eventHandlerMock, onMouseEvent(EMouseEvent::WheelUp, 7, 12)).Times(1);
        proceseAllEvents();
    }
    ...
    TEST_F(WindowX11, negativeMouseWheelEventTriggersMouseWheelDownEvent)
    {
        ...
        EXPECT_CALL(eventHandlerMock, onMouseEvent(EMouseEvent::WheelDown, 7, 12)).Times(1);
        proceseAllEvents();
    }
    ...
    TEST_F(WindowX11, leaveEventTriggersWindowLeaveEvent)
    {
        ...
        EXPECT_CALL(eventHandlerMock, onMouseEvent(EMouseEvent::WindowLeave, 30, 50)).Times(1);
        proceseAllEvents();
    }
    ...
    TEST_F(WindowX11, enterEventTriggersWindowEnterEvent)
    {
        ...
        EXPECT_CALL(eventHandlerMock, onMouseEvent(EMouseEvent::WindowEnter, 10, 20)).Times(1);
        proceseAllEvents();
    }
    ...
    TEST_F(WindowX11, canNotSetExternallyOwnedWindowSizeForNonExternalWindows)
    {
