...
namespace ramses::internal
{
    ...
    protected:
        static void CompositorBindCallback(wl_client* client, [[maybe_unused]] void* data, [[maybe_unused]] uint32_t version, [[maybe_unused]] uint32_t id)
        {
        ...
        static void ResourceDestroyedListener(wl_listener* listener, [[maybe_unused]] void* data)
        {
            ...
            AWaylandClient* waylandClient = wl_container_of(listener, waylandClient, m_destroyListener);
    ...
    namespace
    {
        ...
        public:
            ...
            void run() override
            {
                ...
                m_protocolErrorCode = static_cast<int>(wl_display_get_protocol_error(display, nullptr, nullptr));
        ...
        private:
            static void
            RegistryHandleGlobalCallBack([[maybe_unused]] void* data, struct wl_registry* registry, uint32_t name, const char* interface, [[maybe_unused]] uint32_t version)
            {
            ...
            static void RegistryHandleGlobalRemoveCallBack([[maybe_unused]] void* data, [[maybe_unused]] struct wl_registry* registry, [[maybe_unused]] uint32_t name) {}
