...
namespace ramses::internal
{
    ...
    namespace
    {
        ...
        public:
            ...
            void run() override
            {
                ...
                auto* bufferData = static_cast<uint8_t*>(mmap(nullptr, size, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0));
        ...
        private:
            ...
            static int CreateAnonymousFile(off_t size, std::string& fileName)
            {
                int ret = 0;
            ...
            static void RegistryHandleGlobalRemoveCallBack([[maybe_unused]] void* data, [[maybe_unused]] wl_registry* registry, [[maybe_unused]] uint32_t name) {}
    ...
    protected:
        ...
        {
            auto* awaylandBufferResource = static_cast<AWaylandBufferResource*>(data);
        ...
        static void CompositorCreateSurfaceCallback(wl_client* client, wl_resource* clientResource, uint32_t id)
        {
            ...
            auto* awaylandBufferResource = static_cast<AWaylandBufferResource*>(wl_resource_get_user_data(clientResource));
            wl_resource_set_implementation(resource, &awaylandBufferResource->m_surfaceInterface, awaylandBufferResource, nullptr);
        }

        static void SurfaceAttachCallback(
            [[maybe_unused]] wl_client* client, [[maybe_unused]] wl_resource* surfaceResource, wl_resource* bufferResource, [[maybe_unused]] int x, [[maybe_unused]] int y)
        {
            auto* awaylandBufferResource = static_cast<AWaylandBufferResource*>(wl_resource_get_user_data(surfaceResource));
            ...
            const auto* data = static_cast<const uint8_t*>(waylandBufferResource.bufferGetSharedMemoryData());
        ...
        static void ResourceDestroyedListener(wl_listener* listener, [[maybe_unused]] void* data)
        {
            WARNINGS_PUSH
            ...
            // NOLINTNEXTLINE(modernize-use-auto, cppcoreguidelines-pro-type-cstyle-cast)
