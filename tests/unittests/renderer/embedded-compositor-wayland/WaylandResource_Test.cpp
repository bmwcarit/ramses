...
namespace ramses::internal
{
    ...
    protected:
        void resourceDestroyedListener([[maybe_unused]] void* data)
        {
        ...
        static void ResourceDestroyedCallback([[maybe_unused]] wl_resource* clientResource)
        {
            auto* waylandResource = static_cast<AWaylandResource*>(wl_resource_get_user_data(clientResource));
