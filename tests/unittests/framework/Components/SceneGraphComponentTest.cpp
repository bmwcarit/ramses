...
public:
    ...
    {
        localSceneIdInfo = SceneInfo{ localSceneId, "sceneName", EScenePublicationMode::LocalOnly, ERenderBackendCompatibility::VulkanAndOpenGL, EVulkanAPIVersion::Version_1_1, ESPIRVVersion::Version_1_2 };
        localSceneIdInfoVector.push_back(localSceneIdInfo);
        localAndRemoteSceneIdInfo = SceneInfo{ localSceneId, "sceneName", EScenePublicationMode::LocalAndRemote, ERenderBackendCompatibility::VulkanAndOpenGL, EVulkanAPIVersion::Version_1_1, ESPIRVVersion::Version_1_2 };
        localAndRemoteSceneIdInfoVector.push_back(localAndRemoteSceneIdInfo);
    }

    static SceneActionCollection CreateFakeSceneActionCollectionFromTypes(const std::vector<ESceneActionId>& types)
    {
    ...
    std::vector<std::vector<std::byte>> actionsToChunks(const SceneActionCollection& actions, uint32_t chunkSize = 100000, const ManagedResourceVector& resources = {}, const FlushInformation& flushinfo = {})
    {
    ...
    {
        EXPECT_CALL(communicationSystem, sendSceneUpdate(remote, sceneId, _)).WillOnce([&](auto /*unused*/, auto /*unused*/, auto& serializer) {
    ...
    void publishScene(uint32_t sceneId, std::string name, EScenePublicationMode pubMode)
    {
        SceneInfo info{ SceneId(sceneId), std::move(name), pubMode };
        EXPECT_CALL(consumer, handleNewSceneAvailable(info, _));
        if (pubMode != EScenePublicationMode::LocalOnly)
            EXPECT_CALL(communicationSystem, broadcastNewScenesAvailable(SceneInfoVector{info}, ramses::EFeatureLevel_Latest));
        sceneGraphComponent.sendPublishScene(info);
    }
...
TEST_F(ASceneGraphComponent, sendsSceneToLocalConsumer)
{
    ...
    sceneGraphComponent.sendCreateScene(localParticipantID, SceneInfo{ SceneId(666u), "", EScenePublicationMode::LocalAndRemote });
}
...
TEST_F(ASceneGraphComponent, sendsSceneToRemoteProvider)
{
    ...
    sceneGraphComponent.sendCreateScene(remoteParticipantID, SceneInfo{ SceneId(666u), "", EScenePublicationMode::LocalAndRemote });
}
...
TEST_F(ASceneGraphComponent, publishesSceneAtLocalConsumerInLocalAndRemoteMode)
{
    ...
    sceneGraphComponent.sendPublishScene(localAndRemoteSceneIdInfo);
}
...
TEST_F(ASceneGraphComponentNotConnected, publishesSceneAtLocalConsumerInLocalAndRemoteMode)
{
    ...
    }
    {
        ...
        sceneGraphComponent.sendUnpublishScene(localSceneId, EScenePublicationMode::LocalAndRemote);
    }
}
...
TEST_F(ASceneGraphComponent, publishesSceneAtLocalConsumerInLocalOnlyMode)
{
    ...
    sceneGraphComponent.sendPublishScene(localSceneIdInfo);
}
...
TEST_F(ASceneGraphComponent, publishesSceneAtRemoteProvider)
{
    ...
    sceneGraphComponent.sendPublishScene(SceneInfo{ remoteSceneId, "sceneName", EScenePublicationMode::LocalAndRemote });
}
...
TEST_F(ASceneGraphComponent, locallySubscribedScenesGetUnsubscibedWhenLocalConsumerIsRemoved)
{
    ...
    SceneId sceneId(1);
    SceneInfo sceneInfo{ sceneId, "foo" };
    ...
    sceneGraphComponent.handlePublishScene(SceneId(1), EScenePublicationMode::LocalAndRemote);
...
TEST_F(ASceneGraphComponent, unpublishesSceneAtLocalConsumer)
{
    ...
    EXPECT_CALL(consumer, handleNewSceneAvailable(SceneInfo{ sceneId, "sceneName", EScenePublicationMode::LocalOnly }, _));
    sceneGraphComponent.sendPublishScene(SceneInfo{ sceneId, "sceneName", EScenePublicationMode::LocalOnly });

    EXPECT_CALL(consumer, handleSceneBecameUnavailable(sceneId, _));
    sceneGraphComponent.sendUnpublishScene(sceneId, EScenePublicationMode::LocalOnly);
}
...
TEST_F(ASceneGraphComponent, unpublishesSceneAtRemoteProvider)
{
    ...
    sceneGraphComponent.sendPublishScene(SceneInfo{ sceneId, "sceneName", EScenePublicationMode::LocalAndRemote });
    ...
    sceneGraphComponent.sendUnpublishScene(sceneId, EScenePublicationMode::LocalAndRemote);
}
...
{
    SceneInfoVector newScenes(1, SceneInfo{ remoteSceneId, "sceneName" });
    sceneGraphComponent.sendPublishScene(SceneInfo{ remoteSceneId, "sceneName", EScenePublicationMode::LocalOnly });
...
TEST_F(ASceneGraphComponent, sendsSceneActionToLocalConsumer)
{
    ...
    EXPECT_CALL(consumer, handleSceneUpdate_rvr(SceneId(666u), _, localParticipantID)).WillOnce([&](auto /*unused*/, const auto& update, auto /*unused*/) {
...
TEST_F(ASceneGraphComponent, sendsResourcesUnCompressedToLocalConsumer)
{
    ...
    ManagedResourceVector resources{
        std::make_shared<const ArrayResource>(EResourceType::VertexArray, 1024u, EDataType::Float, blob.data(), "fl")
    };
...
TEST_F(ASceneGraphComponent, sendsResourcesCompressedToRemoteProvider)
{
    ...
    sceneGraphComponent.sendCreateScene(remoteParticipantID, SceneInfo{ sceneId, "", EScenePublicationMode::LocalAndRemote });
    ...
    EXPECT_CALL(communicationSystem, sendSceneUpdate(remoteParticipantID, sceneId, _)).WillOnce([&](auto /*unused*/, auto /*unused*/, auto& serializer) {
    ...
    sceneGraphComponent.sendSceneUpdate({ remoteParticipantID }, std::move(update), sceneId, EScenePublicationMode::LocalAndRemote, sceneStatistics);
}
...
TEST_F(ASceneGraphComponent, canSendSceneActionsToLocalAndRemote)
{
    ...
    InSequence seq;
    expectSendSceneActionsToNetwork(remoteParticipantID, sceneId, list);
    EXPECT_CALL(consumer, handleSceneUpdate_rvr(sceneId, _, localParticipantID)).WillOnce([&](auto /*unused*/, const auto& update, auto /*unused*/) {
        EXPECT_EQ(list, update.actions);
    });
    SceneUpdate update;
    update.actions = list.copy();
    sceneGraphComponent.sendSceneUpdate({ remoteParticipantID, localParticipantID }, std::move(update), sceneId, EScenePublicationMode::LocalAndRemote, sceneStatistics);
}
...
TEST_F(ASceneGraphComponent, canRepublishALocalOnlySceneToBeDistributedRemotely)
{
    ...
    sceneGraphComponent.sendUnpublishScene(localSceneId, EScenePublicationMode::LocalOnly);
    Mock::VerifyAndClearExpectations(&communicationSystem);
    Mock::VerifyAndClearExpectations(&consumer);

    // publish LocalAndRemote
    SceneInfoVector newScenes(1, localAndRemoteSceneIdInfo);
...
{
    sceneGraphComponent.setSceneRendererHandler(&consumer);
    publishScene(1, "name", EScenePublicationMode::LocalAndRemote);
...
{
    sceneGraphComponent.setSceneRendererHandler(&consumer);
    publishScene(1, "name1", EScenePublicationMode::LocalAndRemote);
    publishScene(5, "name2", EScenePublicationMode::LocalOnly);
    publishScene(3, "name3", EScenePublicationMode::LocalAndRemote);
...
{
    SceneInfo sceneInfo{ SceneId(1), "foo" };
    ClientScene scene(sceneInfo);
    ...
    TEST_F(ASceneGraphComponent, forwardsResourceAvailabilityEventsToCorrectHandler)
    {
        ...
        SceneInfo sceneInfo1{ SceneId{ 123 }, "foo" };
...
TEST_F(ASceneGraphComponent, sendSceneReferenceEventViaCommSystemForRemoteParticipant)
{
    ...
    EXPECT_CALL(communicationSystem, sendRendererEvent(remoteParticipantID, SceneId{ 123 }, _)).WillOnce([&event](const Guid& /*unused*/, const SceneId& sceneId , const std::vector<std::byte>& data) -> bool
    {
...
{
    SceneReferenceEvent event(SceneId{ 123 });
    SceneInfo sceneInfo{ SceneId{ 123 }, "foo" };
    ClientScene scene(sceneInfo);
    sceneGraphComponent.handleCreateScene(scene, false, eventConsumer);
    event.type = SceneReferenceEventType::SceneFlushed;
    event.referencedScene = SceneId{ 456 };
    event.tag = SceneVersionTag{ 1000 };
    EXPECT_CALL(eventConsumer, handleSceneReferenceEvent(_, localParticipantID)).WillOnce([&event](SceneReferenceEvent const& e, const Guid& /*unused*/)
    {
        EXPECT_EQ(e.masterSceneId, event.masterSceneId);
        EXPECT_EQ(e.type, event.type);
        EXPECT_EQ(e.referencedScene, event.referencedScene);
...
TEST_F(ASceneGraphComponent, unpacksRendererEventToResourceAvailabilityEventAndForwardsToHandler)
{
    ...
    ClientScene scene(sceneInfo);
    sceneGraphComponent.handleCreateScene(scene, false, eventConsumer);
    event.availableResources.emplace_back(1, 2);
    EXPECT_CALL(eventConsumer, handleResourceAvailabilityEvent(_, localParticipantID)).WillOnce([&event](ResourceAvailabilityEvent const& e, const Guid& /*unused*/)
    {
        EXPECT_EQ(e.sceneid, event.sceneid);
...
TEST_F(ASceneGraphComponent, forwardsPublishFromRemoteToConsumer)
{
    ...
    SceneInfo info_33{ SceneId(1), "", EScenePublicationMode::LocalAndRemote };
    SceneInfo info_22{ SceneId(2), "", EScenePublicationMode::LocalAndRemote };
...
TEST_F(ASceneGraphComponent, forwardsSceneActionListFromRemote)
{
    ...
    EXPECT_CALL(consumer, handleSceneUpdate_rvr(SceneId(2), _, Guid(22))).WillOnce([&](const auto& /*unused*/, const auto& update, const auto& /*unused*/) {
...
TEST_F(ASceneGraphComponent, stopsDeserilizationFromRemotAfterInvalidPacket)
{
    ...
    // break it
    sceneGraphComponent.handleSceneUpdate(SceneId(2), {std::byte{0}}, Guid(22));
...
TEST_F(ASceneGraphComponent, deserializesResourcesFromRemote)
{
    ...
    ManagedResourceVector resources{
        std::make_shared<const ArrayResource>(EResourceType::IndexArray, 1u, EDataType::UInt16, &data1, "ui16"),
        std::make_shared<const ArrayResource>(EResourceType::IndexArray, 1u, EDataType::UInt32, &data2, "ui32"),
        std::make_shared<const ArrayResource>(EResourceType::VertexArray, 1u, EDataType::Float, &data3, "fl")
    };

    SceneActionCollection actions(CreateFakeSceneActionCollectionFromTypes({ ESceneActionId::TestAction }));

    EXPECT_CALL(resourceComponent, manageResource(_)).WillRepeatedly([&](const IResource& res) { return ManagedResource(&res); });
    EXPECT_CALL(consumer, handleSceneUpdate_rvr(SceneId(2), _, Guid(22))).WillOnce([&](const auto& /*unused*/, const auto& update, const auto& /*unused*/) {
...
TEST_F(ASceneGraphComponent, deserializesResourcesFromRemote_SmallChunks)
{
    ...
    ManagedResourceVector resources{
        std::make_shared<const ArrayResource>(EResourceType::IndexArray, 4u, EDataType::UInt16, &data1, "ui16"),
        std::make_shared<const ArrayResource>(EResourceType::IndexArray, 4u, EDataType::UInt32, &data2, "ui32"),
        std::make_shared<const ArrayResource>(EResourceType::VertexArray, 4u, EDataType::Float, &data3, "fl")
    };
...
TEST_F(ASceneGraphComponent, returnsFalseForFlushOnWrongResolvedResourceNumber_Shadow)
{
    ...
    scene.allocateDataSlot({EDataSlotType::TextureProvider, DataSlotId(0u), {}, {}, {111, 111}, {}}, {});
    ...
    scene.allocateDataSlot({EDataSlotType::TextureProvider, DataSlotId(0u), {}, {}, {222, 222}, {}}, {});
...
TEST_F(ASceneGraphComponent, sendSceneUpdatePassesSceneStatisticsToSerializer)
{
    SceneId sceneId;
    EXPECT_CALL(communicationSystem, sendInitializeScene(_, _)).Times(1);
    sceneGraphComponent.sendCreateScene(remoteParticipantID, SceneInfo{ localSceneId, "", EScenePublicationMode::LocalAndRemote });
