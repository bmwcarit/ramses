...
namespace ramses::internal
{
    ...
    {
        struct UInt32Tag {};
        using StronglyTypedUInt32 = ramses::StronglyTypedValue<uint32_t, 10u, UInt32Tag>;

        using StronglyTypedPtr = ramses::StronglyTypedValue<void*, nullptr, struct VoidPtrTag>;
    }
