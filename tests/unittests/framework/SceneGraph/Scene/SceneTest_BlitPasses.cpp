...
namespace ramses::internal
{
    ...
    {
        const RenderBufferHandle sourceRenderBuffer = this->m_scene.allocateRenderBuffer({ 1u, 2u, EPixelStorageFormat::Depth16, ERenderBufferAccessMode::ReadWrite, 0u }, {});
        const RenderBufferHandle destinationRenderBuffer = this->m_scene.allocateRenderBuffer({ 1u, 2u, EPixelStorageFormat::Depth16, ERenderBufferAccessMode::ReadWrite, 0u }, {});
