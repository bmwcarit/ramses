...
namespace ramses::internal
{
    ...
    static const TextureSamplerStates SamplerStates = { ETextureAddressMode::Clamp, ETextureAddressMode::Repeat, ETextureAddressMode::Mirror, ETextureSamplingMethod::Linear, ETextureSamplingMethod::Nearest, 4u };
