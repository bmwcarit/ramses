...
namespace ramses::internal
{
    ...
    public:
        ...
        {
            IResource* res = new ArrayResource(EResourceType::VertexArray, blobSize, EDataType::Vector3F, nullptr, "resName");
            if (blobSize != 0u)
    ...
    {
        const auto res = deser.processData(std::vector<std::byte>(60, std::byte{0}));
        EXPECT_EQ(SceneUpdateStreamDeserializer::ResultType::Failed, res.result);
    }
