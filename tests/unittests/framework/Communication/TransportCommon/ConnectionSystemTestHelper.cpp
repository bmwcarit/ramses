...
namespace ramses::internal
{
    ...
    ConnectionSystemTestDaemon::ConnectionSystemTestDaemon(const std::function<void(RamsesFrameworkConfigImpl&)>& configModifier)
    {
        RamsesFrameworkConfigImpl config(EFeatureLevel_Latest);
        if (configModifier)
