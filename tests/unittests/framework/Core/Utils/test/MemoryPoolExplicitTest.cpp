...
namespace ramses::internal
{
    ...
    TYPED_TEST(AMemoryPoolExplicit, AllocateUsingSpecificHandle)
    {
        ...
        const auto desiredHandle = static_cast<typename TypeParam::handle_type>(this->InitialSize - 10u);
    ...
    TYPED_TEST(AMemoryPoolExplicit, CanAllocateFullCapacity)
    {
        ...
        {
            const auto handle = static_cast<typename TypeParam::handle_type>(i);
