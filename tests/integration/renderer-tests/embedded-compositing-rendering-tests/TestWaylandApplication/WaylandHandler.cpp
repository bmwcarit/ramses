...
namespace ramses::internal
{
    ...
    void WaylandHandler::registry_handle_global(void *data, struct wl_registry *registry, uint32_t name, const char *interface, uint32_t versionProvidedByCompositor)
    {
        ...
        else if (strcmp(interface, "wl_output") == 0)
        {
            ...
            if (waylandHandler->m_requiredWaylandOutputVersion != 0u)
            {
    ...
    void WaylandHandler::registry_handle_global_remove([[maybe_unused]] void* data, [[maybe_unused]] wl_registry* wl_registry, [[maybe_unused]] uint32_t name) {}
    ...
    void WaylandHandler::FrameCallback(void* userData, wl_callback* callback, uint32_t /*unused*/)
    {
        auto* waylandHandler = static_cast<WaylandHandler*>(userData);
        waylandHandler->frameCallback(callback);
    }

    void WaylandHandler::wayland_output_handle_geometry(void* data, wl_output* /*unused*/, int32_t x, int32_t y, int32_t physical_width, int32_t physical_height, int32_t subpixel, const char* /*unused*/, const char* /*unused*/, int32_t transform)
    {
        auto* waylandHandler = static_cast<WaylandHandler*>(data);

        if ((waylandHandler->m_waylandOutputParams.m_waylandOutputReceivedFlags & WaylandOutputTestParams::WaylandOutput_DoneReceived) != 0)
        {
        ...
        if ((waylandHandler->m_waylandOutputParams.m_waylandOutputReceivedFlags & WaylandOutputTestParams::WaylandOutput_GeometryReceived) != 0)
        {
    ...
    void WaylandHandler::wayland_output_handle_mode(void* data, wl_output* /*unused*/, uint32_t flags, int32_t width, int32_t height, int32_t refresh)
    {
        auto* waylandHandler = static_cast<WaylandHandler*>(data);
        ...
        if ((waylandHandler->m_waylandOutputParams.m_waylandOutputReceivedFlags & WaylandOutputTestParams::WaylandOutput_ModeReceived) != 0)
        {
    ...
    void WaylandHandler::wayland_output_handle_done(void *data, wl_output* /*unused*/)
    {
        auto* waylandHandler = static_cast<WaylandHandler*>(data);
        ...
        if ((waylandHandler->m_waylandOutputParams.m_waylandOutputReceivedFlags & WaylandOutputTestParams::WaylandOutput_ScaleReceived) == 0)
        {
    ...
    void WaylandHandler::wayland_output_handle_scale(void* data, wl_output* /*unused*/, int32_t factor)
    {
        auto* waylandHandler = static_cast<WaylandHandler*>(data);
    ...
    SHMBuffer* WaylandHandler::getFreeSHMBuffer(uint32_t width, uint32_t height)
    {
        ...
        auto* buffer = new SHMBuffer(wayland.shm, width, height, m_shmBuffer.size());
