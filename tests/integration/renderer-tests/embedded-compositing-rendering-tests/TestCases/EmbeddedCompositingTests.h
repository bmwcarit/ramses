...
namespace ramses::internal
{
    ...
    {
    public:
        EmbeddedCompositingTests(TestForkingController& testForkingController, const std::vector<std::string>& filterIn, const std::vector<std::string>& filterOut, bool generateScreenshots, const RamsesFrameworkConfig& config)
