...
namespace ramses::internal
{
    ...
    {
        return renderAndGetSurfaceAvailabilityChangeEvents(testFramework, streamSourceId).empty();
    }
    ...
    {
        class StreamAvailabilityChangeEventHandler : public RendererSceneControlEventHandlerEmpty
        {
        public:
            ...
            void streamAvailabilityChanged(waylandIviSurfaceId_t eventStreamSourceId, bool state) override
            {
