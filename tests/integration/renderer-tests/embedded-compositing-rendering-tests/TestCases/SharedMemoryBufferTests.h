...
namespace ramses::internal
{
    ...
    private:
        ...
        static bool RenderAndCheckOneSharedMemoryFrame(EmbeddedCompositingTestsFramework& testFramework, TestApplicationSurfaceId testSurfaceId, ETriangleColor color, WaylandIviSurfaceId waylandSurfaceIviId, uint32_t& frameCount, const std::string& expectedImageName);
        static bool CheckFreeBufferState(EmbeddedCompositingTestsFramework& testFramework, std::string_view bufferFreeState);
