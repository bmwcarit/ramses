...
namespace ramses::internal
{
    ...
    bool TextureRenderingTests::runBasicTest(RendererTestsFramework& testFramework, uint32_t sceneState, const std::string& expectedImageName, float maxAveragePercentErrorPerPixel)
    {
    ...
    template <typename INTEGRATION_SCENE>
    ramses::sceneId_t TextureRenderingTests::createAndShowScene(RendererTestsFramework& testFramework, uint32_t sceneState)
    {
