...
namespace ramses::internal
{
    ...
    TEST_F(ALogicViewerAppUI, modifyInterfaceInput)
    {
        ...
        auto* script = m_app->getLogicViewer()->getLogic().findObject<ramses::LuaScript>("myScript");
    ...
    TEST_F(ALogicViewerAppUI, modifyAnimation)
    {
        ...
        auto* animation = m_app->getLogicViewer()->getLogic().findObject<ramses::AnimationNode>("myAnimation");
    ...
    TEST_F(ALogicViewerAppUI, modifyTimer)
    {
        ...
        auto* timer = m_app->getLogicViewer()->getLogic().findObject<ramses::TimerNode>("myTimer");
    ...
    TEST_F(ALogicViewerAppUI, modifyNodeBinding)
    {
        ...
        auto* node = m_app->getLogicViewer()->getLogic().findObject<ramses::NodeBinding>("myNode");
    ...
    TEST_F(ALogicViewerAppUI, modifyCameraBinding)
    {
        ...
        auto* camera = m_app->getLogicViewer()->getLogic().findObject<ramses::CameraBinding>("myCamera");
    ...
    TEST_F(ALogicViewerAppUI, modifyRenderPass)
    {
        ...
        auto* renderPass = m_app->getLogicViewer()->getLogic().findObject<ramses::RenderPassBinding>("myRenderPass");
    ...
    TEST_F(ALogicViewerAppUI, modifyRenderGroup)
    {
        ...
        auto* renderGroup = m_app->getLogicViewer()->getLogic().findObject<ramses::RenderGroupBinding>("myRenderGroup");
    ...
    TEST_F(ALogicViewerAppUI, modifyMeshNode)
    {
        ...
        auto* meshNode = m_app->getLogicViewer()->getLogic().findObject<ramses::MeshNodeBinding>("myMeshNode");
    ...
    TEST_F(ALogicViewerAppUI, reloadConfiguration)
    {
        ...
        EXPECT_TRUE(contextMenuSelect(700, 350, 7));
...
rlogic.meshNodeBindings["myMeshNode"]["IN"]["instanceCount"].value = 1)", rtrim(ImGui::GetClipboardText()));
    ...
    TEST_F(ALogicViewerAppUI, settings)
    {
        ...
        EXPECT_TRUE(contextMenuSelect(700, 350, 6));
...
ShowDisplaySettings=0)");
        ...
        EXPECT_EQ(11, report.getNodesExecuted().size() + report.getNodesSkippedExecution().size());
