...
namespace ramses::internal
{
    ...
    const ramses::MipLevelData& Texture2DFormatScene::GetTextureFormatAndData(EState state, ramses::ETextureFormat& format, uint32_t& width, uint32_t& height, ramses::TextureSwizzle& swizzle)
    {
        width = 2u;
        height = 2u;
