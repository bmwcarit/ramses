...
{
    CameraDataLinkScene::CameraDataLinkScene(ramses::Scene& scene, uint32_t state, const glm::vec3& cameraPosition)
    ...
    void CameraDataLinkScene::setUpConsumerScene()
    {
        ...
        camera->setFrustum(19.f, static_cast<float>(ramses::internal::IntegrationScene::DefaultViewportWidth) / ramses::internal::IntegrationScene::DefaultViewportHeight, 0.1f, 100.f);
        ...
        dataVpSize->setValue(ramses::vec2i{ int32_t(ramses::internal::IntegrationScene::DefaultViewportWidth), int32_t(ramses::internal::IntegrationScene::DefaultViewportHeight) });
    ...
    void CameraDataLinkScene::setUpProviderScene()
    {
        ...
        dataVpSize->setValue(ramses::vec2i{ int32_t(ramses::internal::IntegrationScene::DefaultViewportWidth / 2), int32_t(ramses::internal::IntegrationScene::DefaultViewportHeight / 2) });
