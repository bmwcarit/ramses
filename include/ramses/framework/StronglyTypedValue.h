    ...
    public:
        ...
        */
        explicit constexpr StronglyTypedValue(BaseType value)
            : m_value(value)
        {
            static_assert(std::is_trivially_copyable_v<StronglyTypedValue>, "should be trivially copyable");
        }
        ...
        */
        ...
        static_assert(std::is_arithmetic_v<BaseType> || std::is_pointer_v<BaseType>, "expected arithmetic or pointer basetype");

    private:
        BaseType m_value{_invalid};
    };
}
