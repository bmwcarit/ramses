...
namespace ramses
{
    ...
    */
    enum class EDataType
    {
        ...
        ByteBlob,   ///< array of std::byte which gets typed later (e.g. interleaved vertex buffer) where one element is always sized as 1 byte

        Bool,       ///< one component of type bool
