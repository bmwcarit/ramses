...
namespace ramses
{
    ...
    /**
    * @brief The SceneConfig holds a set of parameters to be used when creating a scene or loading a scene from file/memory.
    * Some parameters are only relevant for loading a scene.
    * @ingroup CoreAPI
    */
