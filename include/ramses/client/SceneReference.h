    ...
    */
    ...
    public:
        ...
        */
         ...
         */
        [[nodiscard]] internal::SceneReferenceImpl& impl();

        /**
         * Get the internal data for implementation specifics of SceneReference.
         */
        [[nodiscard]] const internal::SceneReferenceImpl& impl() const;
    ...
    protected:
        ...
        */
        explicit SceneReference(std::unique_ptr<internal::SceneReferenceImpl> impl);

        /**
        * Stores internal data for implementation specifics of SceneReference.
        */
        internal::SceneReferenceImpl& m_impl;
    };
}
