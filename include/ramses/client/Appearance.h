...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        *
        * @param[in] srcColor Source color blending factor, default: #ramses::EBlendFactor::SrcAlpha
        * @param[in] destColor Destination color blending factor, default: #ramses::EBlendFactor::OneMinusSrcAlpha
        * @param[in] srcAlpha Source alpha blending factor, default: #ramses::EBlendFactor::One
        * @param[in] destAlpha Destination alpha blending factor, default: #ramses::EBlendFactor::One
        ...
        *
        * @param[in] operationColor Blending operation for color, default: #ramses::EBlendOperation::Disabled
        * @param[in] operationAlpha Blending operation for alpha, default: #ramses::EBlendOperation::Disabled
        * @return true for success, false otherwise (check log or #ramses::RamsesFramework::getLastError for details).
        */
        ...
        * The default value is #ramses::EDepthWrite::Enabled
        *
        ...
        * Default depth comparison function is #ramses::EDepthFunc::LessEqual.
        *
        ...
        * Scissor test is disabled by default (#ramses::EScissorTest::Disabled)
        *
        ...
        *
        * @param[in] func Stencil function to be used, default: #ramses::EStencilFunc::Disabled
        ...
        * Default stencil operation values are #ramses::EStencilOperation::Keep.
        *
        ...
        * Default culling mode is #ramses::ECullMode::BackFacing.
        *
        ...
        * Default draw mode is #ramses::EDrawMode::Triangles, however if the effect used
        ...
        */
         ...
         */
        [[nodiscard]] internal::AppearanceImpl& impl();

        /**
         * Get the internal data for implementation specifics of Appearance.
         */
        [[nodiscard]] const internal::AppearanceImpl& impl() const;
    ...
    protected:
        ...
        */
        explicit Appearance(std::unique_ptr<internal::AppearanceImpl> impl);

        /**
        * Stores internal data for implementation specifics of Appearance.
        */
        internal::AppearanceImpl& m_impl;

    private:
        /// Internal implementation of #setInputValue
        template <typename T> bool setInputValueInternal(const UniformInput& input, T&& value);
        /// Internal implementation of #setInputValue
        template <typename T> bool setInputValueInternal(const UniformInput& input, size_t elementCount, const T* values);
        /// Internal implementation of #getInputValue
        template <typename T> bool getInputValueInternal(const UniformInput& input, T& value) const;
        /// Internal implementation of #getInputValue
        template <typename T> bool getInputValueInternal(const UniformInput& input, size_t elementCount, T* valuesOut) const;
    };

    template <typename T> bool Appearance::setInputValue(const UniformInput& input, T&& value)
    {
    ...
    template <typename T> bool Appearance::setInputValue(const UniformInput& input, size_t elementCount, const T* values)
    {
        static_assert(IsUniformInputDataType<T>(), "Unsupported uniform data type!");
        return setInputValueInternal<T>(input, elementCount, values);
    }

    template <typename T> bool Appearance::getInputValue(const UniformInput& input, T& value) const
    {
        static_assert(IsUniformInputDataType<T>(), "Unsupported uniform data type!");
        return getInputValueInternal<T>(input, value);
    }

    template <typename T> bool Appearance::getInputValue(const UniformInput& input, size_t elementCount, T* valuesOut) const
    {
        static_assert(IsUniformInputDataType<T>(), "Unsupported uniform data type!");
