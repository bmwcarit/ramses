...
namespace ramses
{
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Set the clear flags which enable/disable the clearing of the render target assigned to this RenderPass(default: #ramses::EClearFlag::All)
        ...
        *
        * @param clearFlags clear flags, which is a bitmask of the #ramses::EClearFlag enum
        * @return true for success, false otherwise (check log or #ramses::RamsesFramework::getLastError for details).
        */
        ...
        *
        * @returns clear flags, which is a bitmask of the #ramses::EClearFlag enum
        */
        ...
        */
         ...
         */
        [[nodiscard]] internal::RenderPassImpl& impl();

        /**
         * Get the internal data for implementation specifics of RenderPass.
         */
        [[nodiscard]] const internal::RenderPassImpl& impl() const;
    ...
    protected:
        ...
        */
        explicit RenderPass(std::unique_ptr<internal::RenderPassImpl> impl);

        /**
        * Stores internal data for implementation specifics of RenderPass.
        */
        internal::RenderPassImpl& m_impl;
    };
}
