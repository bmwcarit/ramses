...
namespace ramses
{
    namespace internal
    {
        ...
        class RendererSceneControlImpl;
    }
    ...
    */
    ...
    public:
        ...
        *         true does not guarantee success, the result argument in dispatched event has its own status.
        */
        ...
        */
         ...
         */
        [[nodiscard]] internal::RendererSceneControlImpl& impl();

        /**
         * Get the internal data for implementation specifics of RendererSceneControl.
         */
        [[nodiscard]] const internal::RendererSceneControlImpl& impl() const;

    protected:
        /**
         * Stores internal data for implementation specifics
         */
        std::unique_ptr<internal::RendererSceneControlImpl> m_impl;

    private:
        friend class internal::RamsesRendererImpl;

        /**
         * Constructor
         */
        explicit RendererSceneControl(std::unique_ptr<internal::RendererSceneControlImpl> impl);
