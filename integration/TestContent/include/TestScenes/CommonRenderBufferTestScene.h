...
namespace ramses_internal
{
    ...
    protected:
        ...
        const ramses::MeshNode&     createQuadWithTexture(const ramses::RenderBuffer& renderBuffer, const Vector3& translation);
        ...
        ramses::RenderPass*         addRenderPassUsingRenderBufferAsQuadTexture(ramses::RenderBuffer& sourceRenderBuffer);
