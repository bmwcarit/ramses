...
{
    VisibilityScene::VisibilityScene(ramses::RamsesClient& ramsesClient, ramses::Scene& scene, UInt32 state, const Vector3& cameraPosition)
        : IntegrationScene(ramsesClient, scene, cameraPosition)
    {
        ramses::Effect* effect = getTestEffect("ramses-test-client-basic");
        ramses::Triangle triangle1(m_client, m_scene, *effect, ramses::TriangleAppearance::EColor_Red, 1.f, ramses::TriangleGeometry::EVerticesOrder_CCW);
        ramses::Triangle triangle2(m_client, m_scene, *effect, ramses::TriangleAppearance::EColor_Blue, 1.f, ramses::TriangleGeometry::EVerticesOrder_CW); // different vertices order forces different indices resource used
