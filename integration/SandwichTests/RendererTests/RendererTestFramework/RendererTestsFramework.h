...
public:
    ...
    RenderingTestCase& createTestCase(ramses_internal::UInt32 id, IRendererTest& rendererTest, const std::string& name);
    RenderingTestCase& createTestCaseWithDefaultDisplay(ramses_internal::UInt32 id, IRendererTest& rendererTest, const std::string& name, bool iviWindowStartVisible = true);
    RenderingTestCase& createTestCaseWithoutRenderer(ramses_internal::UInt32 id, IRendererTest& rendererTest, const std::string& name);
