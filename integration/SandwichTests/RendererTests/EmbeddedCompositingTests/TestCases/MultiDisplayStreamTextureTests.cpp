...
namespace ramses_internal
{
    ...
    bool MultiDisplayStreamTextureTests::runEmbeddedCompositingTestCase(EmbeddedCompositingTestsFramework& testFramework, const RenderingTestCase& testCase)
    {
        ...
        case TwoDisplaysWithCompositingOnFirstDisplayOnly:
        {
            ...
            const auto streamBufferDisp1 = testFramework.createStreamBuffer(0u, ramses::waylandIviSurfaceId_t{ waylandSurfaceIviId1.getValue()});
            const auto streamBufferDisp2 = testFramework.createStreamBuffer(1u, ramses::waylandIviSurfaceId_t{ waylandSurfaceIviId1.getValue()});
