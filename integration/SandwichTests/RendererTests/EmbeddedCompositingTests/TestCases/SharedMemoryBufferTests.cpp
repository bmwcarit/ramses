...
namespace ramses_internal
{
    ...
    bool SharedMemoryBufferTests::runEmbeddedCompositingTestCase(EmbeddedCompositingTestsFramework& testFramework, const RenderingTestCase& testCase)
    {
        ...
        const auto streamBuffer1 = testFramework.createStreamBuffer(0u, ramses::waylandIviSurfaceId_t{ waylandSurfaceIviId1.getValue()});
        const auto streamBuffer2 = testFramework.createStreamBuffer(0u, ramses::waylandIviSurfaceId_t{ waylandSurfaceIviId2.getValue()});
    ...
    bool SharedMemoryBufferTests::renderAndCheckOneSharedMemoryFrame(EmbeddedCompositingTestsFramework& testFramework,  TestApplicationSurfaceId testSurfaceId, ETriangleColor color, WaylandIviSurfaceId waylandSurfaceIviId, UInt32& frameCount, const std::string& expectedImageName)
    {
