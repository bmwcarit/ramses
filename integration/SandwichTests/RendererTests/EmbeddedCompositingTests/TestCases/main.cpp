...
int main(int argc, const char *argv[])
{
    ...
    std::vector<ramses_internal::String> filterInTestStrings = ramses_internal::StringUtils::Tokenize(filterIn.c_str(), ':');
    std::vector<ramses_internal::String> filterOutTestStrings = ramses_internal::StringUtils::Tokenize(filterOut.c_str(), ':');
