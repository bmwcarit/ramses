...
bool RenderTargetRenderingTests::runBasicTest(RendererTestsFramework& testFramework, UInt32 sceneState, const std::string& expectedImageName, float maxAveragePercentErrorPerPixel)
{
