...
int main(int argc, char* argv[])
{
    ...
    LOG_INFO(ramses_internal::CONTEXT_SMOKETEST, "ramses-shader-tool-chain-test shows scene");
    ...
    LOG_INFO(ramses_internal::CONTEXT_SMOKETEST, "ramses-shader-tool-chain-test ran through");
