...
{
public:
    OffscreenSetup(ramses_internal::ImguiClientHelper& imguiHelper, ramses::RamsesRenderer* renderer, ramses::Scene* scene, ramses::displayId_t display, uint32_t width, uint32_t height)
...
private:
    ramses_internal::ImguiClientHelper&    m_imguiHelper;
...
{
public:
    FramebufferSetup(ramses_internal::ImguiClientHelper& imguiHelper, ramses::RamsesRenderer* renderer, ramses::Scene* scene, ramses::displayId_t display)
        : m_imguiHelper(imguiHelper)
        , m_sceneControl(renderer->getSceneControlAPI())
        , m_scene(scene)
    {
