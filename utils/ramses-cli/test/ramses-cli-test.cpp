...
{
    EXPECT_EQ(ERamsesShellType::ERamsesShellType_Default, config.m_impl.get().m_shellType);
    cli.parse(std::vector<std::string>{"--ramsh"});
    EXPECT_EQ(ERamsesShellType::ERamsesShellType_Console, config.m_impl.get().m_shellType);
    cli.parse(std::vector<std::string>{"--no-ramsh"});
    EXPECT_EQ(ERamsesShellType::ERamsesShellType_None, config.m_impl.get().m_shellType);
}
