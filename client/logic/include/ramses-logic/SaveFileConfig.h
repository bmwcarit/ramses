...
namespace rlogic
{
    ...
    public:
         ...
         */
        RAMSES_API void setMetadataString(std::string_view metadata);
        ...
        */
         ...
         */
        RAMSES_API SaveFileConfig(const SaveFileConfig& other);

        /**
         * Move Constructor of #SaveFileConfig
         * @param other the other #SaveFileConfig to move from
         */
        RAMSES_API SaveFileConfig(SaveFileConfig&& other) noexcept;
         ...
         * @return self
         */
        RAMSES_API SaveFileConfig& operator=(const SaveFileConfig& other);
         ...
         * @return self
         */
        RAMSES_API SaveFileConfig& operator=(SaveFileConfig&& other) noexcept;
