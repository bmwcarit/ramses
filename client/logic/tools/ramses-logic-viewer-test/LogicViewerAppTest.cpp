...
namespace ramses::internal
{
    ...
    public:
        ...
        {
            createLogicFile();
            [[maybe_unused]] auto status = m_scene.scene->saveToFile(ramsesFile, true);
    ...
    public:
        ...
        {
            auto imgui = m_app->getImguiClientHelper();
            imgui->keyEvent(ramses::displayId_t(0), ramses::EKeyEvent::Pressed, 0, keyCode);
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->keyEvent(ramses::displayId_t(0), ramses::EKeyEvent::Released, 0, keyCode);
            return m_app->doOneLoop();
        }
