...
namespace rlogic::internal
{
    ...
    public:
        ...
        {
            const std::string diffDir        = "../res/unittests/diff/";
            const std::string resourceDir    = "../res/unittests/";
    ...
    public:
        ...
        [[nodiscard]] bool click(int32_t x, int32_t y)
        {
            ...
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_LeftButtonDown, x, y);
            EXPECT_TRUE(m_app->doOneLoop());
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_LeftButtonUp, x, y);
            EXPECT_TRUE(m_app->doOneLoop());
        ...
        {
            auto imgui = m_app->getImguiClientHelper();
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_RightButtonDown, x, y);
            EXPECT_TRUE(m_app->doOneLoop());
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_RightButtonUp, x, y);
            EXPECT_TRUE(m_app->doOneLoop());
            return m_app->doOneLoop();
        }
        ...
        {
            auto imgui = m_app->getImguiClientHelper();
            imgui->keyEvent(ramses::displayId_t(0), ramses::EKeyEvent_Pressed, 0, keyCode);
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->keyEvent(ramses::displayId_t(0), ramses::EKeyEvent_Released, 0, keyCode);
            return m_app->doOneLoop();
        }
        ...
        {
            auto imgui = m_app->getImguiClientHelper();
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_LeftButtonDown, x1, y);
            EXPECT_TRUE(m_app->doOneLoop());
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_LeftButtonDown, x2, y);
            EXPECT_TRUE(m_app->doOneLoop());
            EXPECT_TRUE(m_app->doOneLoop());
            imgui->mouseEvent(ramses::displayId_t(0), ramses::EMouseEvent_LeftButtonUp, x2, y);
            EXPECT_TRUE(m_app->doOneLoop());
            return m_app->doOneLoop();
        }
    ...
    TEST_F(ALogicViewerGuiApp, ImageCompareSelfTest)
    {
        ...
        EXPECT_FALSE(CompareImage("../res/unittests/ALogicViewerApp_red.png", "ALogicViewerApp_white.png"));
        const std::string diffDir = "../res/unittests/diff/";
