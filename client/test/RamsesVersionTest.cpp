...
namespace ramses_internal
{
    ...
    TEST_F(ARamsesVersion, canParseCurrentVersion)
    {
        ...
        EXPECT_EQ(static_cast<uint32_t>(std::atoi(::ramses_sdk::RAMSES_SDK_PROJECT_VERSION_MAJOR)), info.major);
        EXPECT_EQ(static_cast<uint32_t>(std::atoi(::ramses_sdk::RAMSES_SDK_PROJECT_VERSION_MINOR)), info.minor);
