...
namespace ramses
{
    ...
    TYPED_TEST(ACamera, returnsProjectionMatrix)
    {
        ...
        const auto projType = (this->camera->getType() == ERamsesObjectType::PerspectiveCamera ? ramses_internal::ECameraProjectionType::Perspective : ramses_internal::ECameraProjectionType::Orthographic);
