...
namespace ramses
{
    ...
    protected:
        void checkHashSetToInternalScene(const GeometryBinding& geometryBinding, ramses_internal::DataFieldHandle field, const Resource& resource, uint32_t expectedInstancingDivisor) const
        {
        ...
        void checkDataBufferSetToInternalScene(const GeometryBinding& geometryBinding, ramses_internal::DataFieldHandle field, const ArrayBufferImpl& dataBuffer, uint32_t expectedInstancingDivisor) const
        {
        ...
        ArrayResource* setVec3fArrayInput(GeometryBinding& geometry)
        {
            ...
            auto vertices = sharedTestState->getScene().createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vec3Vertices");
        ...
        ArrayResource* setVec2fArrayInput(GeometryBinding& geometry)
        {
            ...
            auto vertices = sharedTestState->getScene().createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vec2Vertices");
            EXPECT_TRUE(vertices != nullptr);
            assert(vertices);
        ...
        ArrayResource* setVec4fArrayInput(GeometryBinding& geometry)
        {
            ...
            auto vertices = sharedTestState->getScene().createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vec4Vertices");
            EXPECT_TRUE(vertices != nullptr);
            assert(vertices);
        ...
        {
            float verts[8] = { 0.1f };
            auto vertices = sharedTestState->getScene().createArrayResource(8u, verts, ResourceCacheFlag_DoNotCache, "floatVertices");
            EXPECT_TRUE(vertices != nullptr);
            assert(vertices);
        ...
        {
            uint32_t inds[3] = { 0u };
            auto indices = sharedTestState->getScene().createArrayResource(3u, inds, ramses::ResourceCacheFlag_DoNotCache, "indices");
    ...
    TEST_F(GeometryBindingTest, canSetResource)
    {
        ...
        const vec3f vert{ 0.f, 1.f, 2.f };
        ArrayResource* const vertices = sharedTestState->getScene().createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vertices");
    ...
    TEST_F(GeometryBindingTest, reportsErrorWhenSettingVec2ArrayResourceFromAnotherScene)
    {
        ...
        ArrayResource* const vertices = anotherScene.createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vec2Vertices");
        ASSERT_TRUE(vertices != nullptr);
    ...
    TEST_F(GeometryBindingTest, reportsErrorWhenSetIndicesWithWrongTypeArrayResourceFLoat)
    {
        ...
        ArrayResource* const indices = sharedTestState->getScene().createArrayResource(4u, inds, ramses::ResourceCacheFlag_DoNotCache, "indices");
        ASSERT_TRUE(indices);
    ...
    TEST_F(GeometryBindingTest, reportsErrorWhenSetIndicesWithWrongTypeArrayResourceVec2F)
    {
        ...
        ArrayResource* const indices = sharedTestState->getScene().createArrayResource(1u, &indice, ramses::ResourceCacheFlag_DoNotCache, "indices");
        ASSERT_TRUE(indices);
    ...
    TEST_F(GeometryBindingTest, reportsErrorWhenSetIndicesWithWrongTypeArrayResourceByteBlob)
    {
        ...
        const ramses::Byte inds[4] = { 0, 1, 2, 3 };
        ArrayResource* const indices = sharedTestState->getScene().createArrayResource(sizeof(inds), inds, ramses::ResourceCacheFlag_DoNotCache, "indices");
        ASSERT_TRUE(indices);
    ...
    TEST_F(GeometryBindingTest, canSetVertexDataBufferInput_ArrayResourceByteBlob)
    {
        ...
        ArrayResource* const interleavedVertices = sharedTestState->getScene().createArrayResource(sizeof(data), reinterpret_cast<const ramses::Byte*>(data));
        ASSERT_TRUE(interleavedVertices != nullptr);
    ...
    TEST_F(GeometryBindingTest, canSetArrayResourceByteBlobToSingleAttribute)
    {
        ...
        const float data[10] = { 1.f };
        // NOLINTNEXTLINE(cppcoreguidelines-pro-type-reinterpret-cast) interleaved vertices passed as byte blob
        ArrayResource* const vertices = sharedTestState->getScene().createArrayResource(sizeof(data), reinterpret_cast<const ramses::Byte*>(data));
        ASSERT_TRUE(vertices);
    ...
    TEST_F(GeometryBindingTest, cannotSetStrideAndOffsetToNonByteBlobVertexArrayResource)
    {
        ...
        const vec2f vert{ 0.f, 1.f };
        const auto vertices = sharedTestState->getScene().createArrayResource(1u, &vert, ramses::ResourceCacheFlag_DoNotCache, "vertices");
        ASSERT_TRUE(vertices);
