...
#ifndef RAMSES_DATAVECTOR2I_H
#define RAMSES_DATAVECTOR2I_H
...
namespace ramses
{
    ...
    /**
     * @brief The DataVector2i data object stores a vector with two 32-bit-integer components within a scene.
     */
    class RAMSES_API DataVector2i : public DataObject
    {
    public:
        /**
         ...
         *         to resolve error message using getStatusMessage().
         */
        status_t getValue(int32_t& x, int32_t& y) const;

    protected:
        /**
         * @brief Scene is the factory for creating DataVector2i instances.
         */
        friend class SceneImpl;

        /**
         * @brief Constructor of DataVector2i
         *
         * @param[in] pimpl Internal data for implementation specifics of a DataObject (sink - instance becomes owner)
         */
        explicit DataVector2i(DataObjectImpl& pimpl);

        /**
         * @brief Destructor of the DataVector2i
         */
        ~DataVector2i() override;
    };
}
