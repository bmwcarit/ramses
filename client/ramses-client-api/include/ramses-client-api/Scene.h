    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Creates a GroupNode in this Scene
        *
        * @param[in] name The optional name of the GroupNode
        * @return Pointer to the created GroupNode, null on failure
        */
        GroupNode* createGroupNode(const char* name = 0);
        ...
        */
        ...
        /**
         * @brief Creates a MeshNode in this Scene
         *
        ...
        */
        ...
        /**
        * @brief Creates a TranslateNode in this Scene
        *
        * @param[in] name The optional name of the TranslateNode
        * @return Pointer to the created TranslateNode, null on failure
        */
        TranslateNode* createTranslateNode(const char* name = 0);

        /**
        * @brief Creates a RotateNode in this Scene
        *
        * @param[in] name The optional name of the RotateNode
        * @return Pointer to the created RotateNode, null on failure
        */
        RotateNode* createRotateNode(const char* name = 0);

        /**
        * @brief Creates a ScaleNode in this Scene
        *
        * @param[in] name The optional name of the ScaleNode
        * @return Pointer to the created ScaleNode, null on failure
        */
        ScaleNode* createScaleNode(const char* name = 0);

        /**
        * @brief Creates a VisibilityNode in this Scene
        *
        * Per default all newly created VisibilityNodes are
        * set to visible.
        *
        * @param[in] name The optional name of the VisibilityNode
        * @return Pointer to the created ScaleNode, null on failure
        */
        VisibilityNode* createVisibilityNode(const char* name = 0);
        ...
        */
        ...
        /**
        * @brief Same as \c ramses::Scene::flush with additional timestamp used for latency checking.
        *        If this scene was configured for latency monitoring (see ramses::SceneConfig::setMaximumLatency)
        *        there has to be timestamp provided which will be used to check on the renderer side and report a renderer event
        *        if the latency limit is exceeded.
        *
        *        The point in time when this scene with this flush applied is rendered must not be after
        *        ptpTimestampInMilliseconds + latencyTimeout, otherwise a renderer event is reported using the renderer events
        *        dispatch mechanism (see ramses::IRendererEventHandler::sceneUpdateLatencyExceeded).
        *
        * @param[in] ptpTimestampInMilliseconds PTP timestamp in milliseconds (must be strictly > 0)
        * @param[in] sceneVersionTag updates the version tag of the scene along with the flushed scene updates.
        *            If set to a valid value, a subscribed renderer will generate a sceneFlushed() event when the
        *            scene update has been applied. Invalid scene version ids are ignored.
        *            Defaults to InvalidSceneVersionTag.
        ...
        *         to resolve error message using getStatusMessage().
        */
        status_t flushWithTimestamp(uint64_t ptpTimestampInMilliseconds, sceneVersionTag_t sceneVersionTag = InvalidSceneVersionTag);
        ...
        * @return Pointer to the created TransformationNode
        **/
        TransformationNode* createTransformationNode(const char* name = 0);
        ...
        *            usual values: 1, 2, 4, 8, 16 (dependant on graphics platform)
        * @param[in] name Optional name of the object.
        ...
        */
        ...
        /**
        * @brief Annotates a GroupNode as a transformation data consumer.
        *        Data provider and data consumer can be linked on Ramses Renderer side.
        *        Linking data means that the consumer's data property will be overridden by provider's data property.
        ...
        *         to resolve error message using getStatusMessage().
        */
        status_t createTransformationDataConsumer(const GroupNode& node, dataConsumerId_t dataId);
