...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API Texture2DBuffer* createTexture2DBuffer(ETextureFormat textureFormat, uint32_t width, uint32_t height, size_t mipLevelCount, std::string_view name = {});
