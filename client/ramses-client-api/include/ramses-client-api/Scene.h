...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API status_t publish(EScenePublicationMode publicationMode = EScenePublicationMode::LocalAndRemote);
        ...
        *         to resolve error message using getStatusMessage().
        */
        [[nodiscard]] RAMSES_API status_t saveToFile(std::string_view fileName, bool compress) const;
        ...
        */
        RAMSES_API PerspectiveCamera* createPerspectiveCamera(std::string_view name = {});
        ...
        * @return Pointer to the created Camera, null on failure
        */
        RAMSES_API OrthographicCamera* createOrthographicCamera(std::string_view name = {});
        ...
        */
        RAMSES_API Appearance* createAppearance(const Effect& effect, std::string_view name = {});
        ...
        */
        RAMSES_API GeometryBinding* createGeometryBinding(const Effect& effect, std::string_view name = {});
        ...
        **/
        RAMSES_API Node* createNode(std::string_view name = {});
        ...
        */
        RAMSES_API MeshNode* createMeshNode(std::string_view name = {});
        ...
        */
        [[nodiscard]] RAMSES_API const RamsesObject* findObjectByName(std::string_view name) const;

        /**
        * @copydoc findObjectByName(std::string_view) const
        **/
        RAMSES_API RamsesObject* findObjectByName(std::string_view name);
        ...
        **/
        RAMSES_API RenderGroup* createRenderGroup(std::string_view name = {});
        ...
        **/
        RAMSES_API RenderPass* createRenderPass(std::string_view name = {});
        ...
        **/
        RAMSES_API BlitPass* createBlitPass(const RenderBuffer& sourceRenderBuffer, const RenderBuffer& destinationRenderBuffer, std::string_view name = {});
        ...
        **/
        RAMSES_API RenderBuffer* createRenderBuffer(uint32_t width, uint32_t height, ERenderBufferType bufferType, ERenderBufferFormat bufferFormat, ERenderBufferAccessMode accessMode, uint32_t sampleCount = 0u, std::string_view name = {});
        ...
        **/
        RAMSES_API PickableObject* createPickableObject(const ArrayBuffer& geometryBuffer, const pickableObjectId_t id, std::string_view name = {});
        ...
        **/
        RAMSES_API RenderTarget* createRenderTarget(const RenderTargetDescription& rtDesc, std::string_view name = {});
        ...
        */
        RAMSES_API TextureSamplerMS* createTextureSamplerMS(const RenderBuffer& renderBuffer, std::string_view name);
        ...
        */
        RAMSES_API Effect* createEffect(const EffectDescription& effectDesc, resourceCacheFlag_t cacheFlag = ResourceCacheFlag_DoNotCache, std::string_view name = {});
        ...
        */
        RAMSES_API ArrayBuffer* createArrayBuffer(EDataType dataType, uint32_t maxNumElements, std::string_view name = {});
        ...
        */
        RAMSES_API Texture2DBuffer* createTexture2DBuffer(ETextureFormat textureFormat, uint32_t width, uint32_t height, uint32_t mipLevelCount, std::string_view name = {});
        ...
        */
        RAMSES_API DataObject* createDataObject(EDataType dataType, std::string_view name = {});
        ...
        */
        RAMSES_API SceneReference* createSceneReference(sceneId_t referencedScene, std::string_view name = {});
    ...
    private:
        ...
        template <typename T> RAMSES_API ArrayResource* createArrayResourceInternal(uint32_t numElements, const T* arrayData, resourceCacheFlag_t cacheFlag, std::string_view name);
    };

    template <typename T> ArrayResource* Scene::createArrayResource(uint32_t numElements, const T* arrayData, resourceCacheFlag_t cacheFlag, std::string_view name)
    {
