...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API status_t updateData(size_t mipLevel, uint32_t offsetX, uint32_t offsetY, uint32_t width, uint32_t height, const void* data);
        ...
        */
        [[nodiscard]] RAMSES_API size_t getMipLevelCount() const;
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t getMipLevelSize(size_t mipLevel, uint32_t& widthOut, uint32_t& heightOut) const;
        ...
        */
        [[nodiscard]] RAMSES_API size_t getMipLevelDataSizeInBytes(size_t mipLevel) const;
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t getMipLevelData(size_t mipLevel, void* buffer, size_t bufferSize) const;
