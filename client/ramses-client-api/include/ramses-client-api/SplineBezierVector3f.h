...
#ifndef RAMSES_SPLINEBEZIERVECTOR3F_H
#define RAMSES_SPLINEBEZIERVECTOR3F_H
...
{
    /**
    * @brief The SplineBezierVector3f stores spline keys of type Vector3f that can be used for animation with Bezier interpolation.
    */
    class RAMSES_API SplineBezierVector3f : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineBezierVector3f instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineBezierVector3f
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineBezierVector3f(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineBezierVector3f
        */
        virtual ~SplineBezierVector3f();
    };
}
