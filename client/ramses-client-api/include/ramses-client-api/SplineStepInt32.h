...
#ifndef RAMSES_SPLINESTEPINT32_H
#define RAMSES_SPLINESTEPINT32_H
...
{
    /**
    * @brief The SplineStepInt32 stores spline keys of type int32_t that can be used for animation with step interpolation.
    */
    class RAMSES_API SplineStepInt32 : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineStepInt32 instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineStepInt32
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineStepInt32(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineStepInt32
        */
