...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API Scene* createScene(sceneId_t sceneId, const SceneConfig& sceneConfig = SceneConfig(), std::string_view name = {});
        ...
        */
        ...
        /**
        * @brief Loads scene contents and resources from an open file descriptor.
        * This overload overrides the sceneId stored in the file.
        *
        * The file format has to match current Ramses SDK version in major and minor version number.
        * This method is not back compatible and will fail
        * if trying to load scene files saved using older Ramses SDK version.
        ...
        */
        RAMSES_API static bool GetFeatureLevelFromFile(std::string_view fileName, EFeatureLevel& detectedFeatureLevel);
        ...
        */
        [[nodiscard]] RAMSES_API const Scene* findSceneByName(std::string_view name) const;

        /**
        * @copydoc findSceneByName(std::string_view) const
        **/
        RAMSES_API Scene* findSceneByName(std::string_view name);
