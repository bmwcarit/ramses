...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        template <typename T>
        status_t setInputValue(const UniformInput& input, size_t elementCount, const T* values);
        ...
        */
        template <typename T>
        status_t getInputValue(const UniformInput& input, size_t elementCount, T* valuesOut) const;
    ...
    private:
        ...
        /// Internal implementation of #setInputValue
        template <typename T> RAMSES_API status_t setInputValueInternal(const UniformInput& input, size_t elementCount, const T* values);
        ...
        /// Internal implementation of #getInputValue
        template <typename T> RAMSES_API status_t getInputValueInternal(const UniformInput& input, size_t elementCount, T* valuesOut) const;
    };
    ...
    template <typename T> status_t Appearance::setInputValue(const UniformInput& input, size_t elementCount, const T* values)
    {
        static_assert(IsUniformInputDataType<T>(), "Unsupported uniform data type!");
    ...
    template <typename T> status_t Appearance::getInputValue(const UniformInput& input, size_t elementCount, T* valuesOut) const
    {
        static_assert(IsUniformInputDataType<T>(), "Unsupported uniform data type!");
