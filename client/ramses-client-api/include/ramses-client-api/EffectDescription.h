...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        RAMSES_API status_t setVertexShader(std::string_view shaderSource);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setFragmentShader(std::string_view shaderSource);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setGeometryShader(std::string_view shaderSource);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setVertexShaderFromFile(std::string_view shaderSourceFileName);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setFragmentShaderFromFile(std::string_view shaderSourceFileName);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setGeometryShaderFromFile(std::string_view shaderSourceFileName);
        /**
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t addCompilerDefine(std::string_view define);
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setUniformSemantic(std::string_view inputName, EEffectUniformSemantic semanticType);
        ...
        *         to resolve error message using getStatusMessage().
        */
        RAMSES_API status_t setAttributeSemantic(std::string_view inputName, EEffectAttributeSemantic semanticType);
        ...
        */
        [[nodiscard]] RAMSES_API size_t getNumberOfCompilerDefines() const;
        /**
        ...
        */
        [[nodiscard]] RAMSES_API const char* getCompilerDefine(size_t index) const;
