...
#ifndef RAMSES_SPLINELINEARVECTOR3I_H
#define RAMSES_SPLINELINEARVECTOR3I_H
...
{
    /**
    * @brief The SplineLinearVector3i stores spline keys of type Vector3i that can be used for animation with linear interpolation.
    */
    class RAMSES_API SplineLinearVector3i : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineLinearVector3i instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineLinearVector3i
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineLinearVector3i(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineLinearVector3i
        */
        virtual ~SplineLinearVector3i();
    };
}
