    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Create a new animated property for TranslateNode
        *
        ...
        * @return AnimatedProperty referring to TranslateNode, null on failure
        */
        AnimatedProperty* createAnimatedProperty(const TranslateNode& propertyOwner, EAnimatedPropertyComponent propertyComponent = EAnimatedPropertyComponent_All, const char* name = 0);

        /**
        * @brief Create a new animated property for RotateNode
        *
        * @param[in] propertyOwner Reference to an entity that contains data to animate.
        * @param[in] propertyComponent The optional component to animate in case of vector property.
        * @param[in] name The optional name of the AnimatedProperty.
        * @return AnimatedProperty referring to RotateNode, null on failure
        */
        AnimatedProperty* createAnimatedProperty(const RotateNode& propertyOwner, EAnimatedPropertyComponent propertyComponent = EAnimatedPropertyComponent_All, const char* name = 0);

        /**
        * @brief Create a new animated property for ScaleNode
        *
        * @param[in] propertyOwner Reference to an entity that contains data to animate.
        * @param[in] propertyComponent The optional component to animate in case of vector property.
        * @param[in] name The optional name of the AnimatedProperty.
        * @return AnimatedProperty referring to ScaleNode, null on failure
        */
        AnimatedProperty* createAnimatedProperty(const ScaleNode& propertyOwner, EAnimatedPropertyComponent propertyComponent = EAnimatedPropertyComponent_All, const char* name = 0);
