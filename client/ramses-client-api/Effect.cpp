...
namespace ramses
{
    ...
    status_t Effect::getUniformInput(size_t index, UniformInput& uniformInput) const
    {
    ...
    status_t Effect::getAttributeInput(size_t index, AttributeInput& attributeInput) const
    {
    ...
    status_t Effect::findUniformInput(std::string_view inputName, UniformInput& uniformInput) const
    {
        return m_impl.findUniformInput(inputName, uniformInput.m_impl);
    }

    status_t Effect::findAttributeInput(std::string_view inputName, AttributeInput& attributeInput) const
    {
