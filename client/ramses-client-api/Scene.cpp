...
namespace ramses
{
    ...
    template <typename T>
    ArrayResource* Scene::createArrayResourceInternal(uint32_t numElements, const T* arrayData, resourceCacheFlag_t cacheFlag, const char* name)
    {
        auto arr = impl.createArrayResource<T>(numElements, arrayData, cacheFlag, name);
    ...
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<uint16_t>(uint32_t, const uint16_t*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<uint32_t>(uint32_t, const uint32_t*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<float>(uint32_t, const float*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<vec2f>(uint32_t, const vec2f*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<vec3f>(uint32_t, const vec3f*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<vec4f>(uint32_t, const vec4f*, resourceCacheFlag_t, const char*);
    template RAMSES_API ArrayResource* Scene::createArrayResourceInternal<Byte>(uint32_t, const Byte*, resourceCacheFlag_t, const char*);
}
