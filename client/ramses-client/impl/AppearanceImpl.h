...
namespace ramses
{
    ...
    public:
        ...
        template <typename T>
        status_t setInputValue(const EffectInputImpl& input, size_t elementCount, const T* valuesIn);
        template <typename T>
        status_t getInputValue(const EffectInputImpl& input, size_t elementCount, T* valuesOut) const;
    ...
    private:
        ...
        status_t checkEffectInputValidityAndValueCompatibility(const EffectInputImpl& input, size_t valueElementCount, std::initializer_list<ramses_internal::EDataType> valueDataType) const;
        ...
        template <typename T>
        status_t setDataArrayChecked(size_t elementCount, const T* values, const EffectInputImpl& input);
        template <typename T>
        status_t getDataArrayChecked(size_t elementCount, T* values, const EffectInputImpl& input) const;
