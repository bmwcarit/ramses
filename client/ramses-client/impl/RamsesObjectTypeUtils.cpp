...
namespace ramses
{
    const char* RamsesObjectTypeNames[] =
    {
        ...
        "ERamsesObjectType_GroupNode",
        "ERamsesObjectType_TranslateNode",
        "ERamsesObjectType_RotateNode",
        "ERamsesObjectType_ScaleNode",
        "ERamsesObjectType_TransformationNode",
        ...
        "ERamsesObjectType_VisibilityNode",
