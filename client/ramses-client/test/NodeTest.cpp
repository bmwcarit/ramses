...
namespace ramses
{
    ...
    TYPED_TEST(NodeTest, getsModelMatrixComputedFromTransformationChain_SingleNode)
    {
        ...
        const ramses_internal::Matrix44f rotMat = ramses_internal::Matrix44f::RotationEuler({ 7.f, 8.f, 9.f }, ramses_internal::ERotationConvention::Legacy_ZYX);
    ...
    TYPED_TEST(NodeTest, getsInverseModelMatrixComputedFromTransformationChain_SingleNode)
    {
        ...
        const ramses_internal::Matrix44f rotMat = ramses_internal::Matrix44f::RotationEuler({ 7.f, 8.f, 9.f }, ramses_internal::ERotationConvention::Legacy_ZYX).transpose();
