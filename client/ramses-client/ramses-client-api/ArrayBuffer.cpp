...
namespace ramses
{
    ...
    {
        const status_t status = impl.updateData(firstElement, numElements, static_cast<const ramses_internal::Byte*>(bufferData));
    ...
    {
        return impl.getData(static_cast<ramses_internal::Byte*>(buffer), numElements);
    }
}
