...
#ifndef RAMSES_SPLINELINEARVECTOR4I_H
#define RAMSES_SPLINELINEARVECTOR4I_H
...
{
    /**
    * @brief The SplineLinearVector4i stores spline keys of type Vector4i that can be used for animation with linear interpolation.
    */
    class RAMSES_API SplineLinearVector4i : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineLinearVector4i instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineLinearVector4i
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineLinearVector4i(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineLinearVector4i
        */
        virtual ~SplineLinearVector4i();
    };
}
