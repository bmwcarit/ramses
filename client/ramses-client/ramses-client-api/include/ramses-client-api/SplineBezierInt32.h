...
#ifndef RAMSES_SPLINEBEZIERINT32_H
#define RAMSES_SPLINEBEZIERINT32_H
...
{
    /**
    * @brief The SplineBezierInt32 stores spline keys of type int32_t that can be used for animation with Bezier interpolation.
    */
    class RAMSES_API SplineBezierInt32 : public Spline
    {
    public:
        /**
        ...
        */
        status_t setKey(splineTimeStamp_t timeStamp, int32_t value, float tangentIn_x, float tangentIn_y, float tangentOut_x, float tangentOut_y);
        ...
        *         to resolve error message using getStatusMessage().
        */
        status_t getKeyValues(splineKeyIndex_t keyIndex, splineTimeStamp_t& timeStamp, int32_t& value, float& tangentIn_x, float& tangentIn_y, float& tangentOut_x, float& tangentOut_y) const;

    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineBezierInt32 instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineBezierInt32
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineBezierInt32(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineBezierInt32
        */
        virtual ~SplineBezierInt32();
    };
}
