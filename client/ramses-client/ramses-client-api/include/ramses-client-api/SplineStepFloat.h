...
#ifndef RAMSES_SPLINESTEPFLOAT_H
#define RAMSES_SPLINESTEPFLOAT_H
...
{
    /**
    * @brief The SplineStepFloat stores spline keys of type float that can be used for animation with step interpolation.
    */
    class RAMSES_API SplineStepFloat : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineStepFloat instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineStepFloat
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineStepFloat(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineStepFloat
        */
        virtual ~SplineStepFloat();
    };
}
