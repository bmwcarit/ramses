...
#ifndef RAMSES_SPLINELINEARVECTOR4F_H
#define RAMSES_SPLINELINEARVECTOR4F_H
...
{
    /**
    * @brief The SplineLinearVector4f stores spline keys of type Vector4f that can be used for animation with linear interpolation.
    */
    class RAMSES_API SplineLinearVector4f : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineLinearVector4f instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineLinearVector4f
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineLinearVector4f(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineLinearVector4f
        */
