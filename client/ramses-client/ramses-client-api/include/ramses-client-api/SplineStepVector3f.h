...
#ifndef RAMSES_SPLINESTEPVECTOR3F_H
...
{
    /**
    * @brief The SplineStepVector3f stores spline keys of type Vector3f that can be used for animation with step interpolation.
    */
    class RAMSES_API SplineStepVector3f : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineStepVector3f instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineStepVector3f
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineStepVector3f(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineStepVector3f
        */
        virtual ~SplineStepVector3f();
    };
}
