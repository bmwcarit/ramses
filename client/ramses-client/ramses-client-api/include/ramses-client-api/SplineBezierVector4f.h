...
#ifndef RAMSES_SPLINEBEZIERVECTOR4F_H
#define RAMSES_SPLINEBEZIERVECTOR4F_H
...
{
    /**
    * @brief The SplineBezierVector4f stores spline keys of type Vector4f that can be used for animation with Bezier interpolation.
    */
    class RAMSES_API SplineBezierVector4f : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineBezierVector4f instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineBezierVector4f
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineBezierVector4f(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineBezierVector4f
        */
