...
#ifndef RAMSES_SPLINESTEPVECTOR4I_H
#define RAMSES_SPLINESTEPVECTOR4I_H
...
{
    /**
    * @brief The SplineStepVector4i stores spline keys of type Vector4i that can be used for animation with step interpolation.
    */
    class RAMSES_API SplineStepVector4i : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineStepVector4i instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineStepVector4i
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineStepVector4i(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineStepVector4i
        */
