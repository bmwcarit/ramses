...
#ifndef RAMSES_SPLINESTEPVECTOR2F_H
#define RAMSES_SPLINESTEPVECTOR2F_H
...
{
    /**
    * @brief The SplineStepVector2f stores spline keys of type Vector2f that can be used for animation with step interpolation.
    */
    class RAMSES_API SplineStepVector2f : public Spline
    {
    public:
        /**
    ...
    protected:
        /**
        * @brief AnimationSystemData is the factory for creating SplineStepVector2f instances.
        */
        friend class AnimationSystemData;

        /**
        * @brief Constructor of SplineStepVector2f
        *
        * @param[in] pimpl Internal data for implementation specifics of Spline (sink - instance becomes owner)
        */
        explicit SplineStepVector2f(SplineImpl& pimpl);

        /**
        * @brief Destructor of the SplineStepVector2f
        */
