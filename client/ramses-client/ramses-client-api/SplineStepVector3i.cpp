...
namespace ramses
{
    SplineStepVector3i::SplineStepVector3i(SplineImpl& pimpl)
        : Spline(pimpl)
    {
    }

    SplineStepVector3i::~SplineStepVector3i()
    {
    }
    ...
    status_t SplineStepVector3i::getKeyValues(splineKeyIndex_t keyIndex, splineTimeStamp_t& timeStamp, int32_t& x, int32_t& y, int32_t& z) const
    {
