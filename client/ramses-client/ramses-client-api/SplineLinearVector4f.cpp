...
namespace ramses
{
    SplineLinearVector4f::SplineLinearVector4f(SplineImpl& pimpl)
        : Spline(pimpl)
    {
    }

    SplineLinearVector4f::~SplineLinearVector4f()
    {
    }
    ...
    status_t SplineLinearVector4f::getKeyValues(splineKeyIndex_t keyIndex, splineTimeStamp_t& timeStamp, float& x, float& y, float& z, float& w) const
    {
