...
namespace ramses_internal
{
    ...
    public:
        ...
        virtual bool                        isPickableObjectAllocated       (PickableObjectHandle pickableHandle) const = 0;
        virtual UInt32                      getPickableObjectCount          () const = 0;
        ...
        virtual const PickableObject&       getPickableObject               (PickableObjectHandle pickableHandle) const  = 0;
