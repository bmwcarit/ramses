...
namespace ramses_internal
{
    ...
    public:
        ...
        // Nodes
        virtual NodeHandle                  allocateNode                    (uint32_t childrenCount = 0u, NodeHandle handle = NodeHandle::Invalid()) = 0;
        ...
        // Render groups
        virtual RenderGroupHandle           allocateRenderGroup             (uint32_t renderableCount = 0u, uint32_t nestedGroupCount = 0u, RenderGroupHandle groupHandle = RenderGroupHandle::Invalid()) = 0;
        ...
        // Render passes
        virtual RenderPassHandle            allocateRenderPass              (uint32_t renderGroupCount = 0u, RenderPassHandle passHandle = RenderPassHandle::Invalid()) = 0;
        ...
        virtual void                        setRenderPassClearFlag          (RenderPassHandle passHandle, uint32_t clearFlag) = 0;
        ...
        // Data buffers
        virtual DataBufferHandle            allocateDataBuffer              (EDataBufferType dataBufferType, EDataType dataType, uint32_t maximumSizeInBytes, DataBufferHandle handle = DataBufferHandle::Invalid()) = 0;
        ...
        virtual void                        updateDataBuffer                (DataBufferHandle handle, uint32_t offsetInBytes, uint32_t dataSizeInBytes, const Byte* data) = 0;
        ...
        virtual void                        updateTextureBuffer             (TextureBufferHandle handle, uint32_t mipLevel, uint32_t x, uint32_t y, uint32_t width, uint32_t height, const Byte* data) = 0;
