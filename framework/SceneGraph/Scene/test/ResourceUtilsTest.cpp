...
namespace ramses_internal
{
    ...
    {
        this->scene.allocateDataSlot({ EDataSlotType_TextureProvider, DataSlotId(0u), NodeHandle(), DataInstanceHandle(), hash1, TextureSamplerHandle() }, this->template getNextHandle<DataSlotHandle>());
        this->expectResources({ hash1 });
    }

    TYPED_TEST(AResourceUtils, addsTextureResourceWhenUsedBySetDataSlotTexture)
    {
        const auto slotHandle = this->scene.allocateDataSlot({ EDataSlotType_TextureProvider, DataSlotId(0u), NodeHandle(), DataInstanceHandle(), hash1, TextureSamplerHandle() }, this->template getNextHandle<DataSlotHandle>());
        this->expectResources({ hash1 });
    ...
    {
        const DataSlotHandle dataSlot = this->scene.allocateDataSlot({ EDataSlotType_TextureProvider, DataSlotId(0u), NodeHandle(), DataInstanceHandle(), hash1, TextureSamplerHandle() }, this->template getNextHandle<DataSlotHandle>());
        this->expectResources({ hash1 });
    ...
    TYPED_TEST(AResourceUtils, doesNotRemoveTextureWhenUsedByDestroyedDataSlotButStillInUse)
    {
        ...
        auto dataSlot = this->scene.allocateDataSlot({ EDataSlotType_TextureProvider, DataSlotId(0u), NodeHandle(), DataInstanceHandle(), hash1, TextureSamplerHandle() }, this->template getNextHandle<DataSlotHandle>());
        this->expectResources({ hash1 });
