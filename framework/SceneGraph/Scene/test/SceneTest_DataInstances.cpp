...
namespace ramses_internal
{
    ...
    TYPED_TEST(AScene, SetsTheValueOfADataInstanceProperty)
    {
        ...
        this->m_scene.setDataSingleMatrix33f      (containerHandle, DataFieldHandle(14u), Matrix33f::Rotation({ 1.0f, 2.0f, 3.0f, 1.f }, ERotationType::Euler_XYZ));
        ...
        expectMatrixFloatEqual(Matrix33f::Rotation({ 1.0f, 2.0f, 3.0f, 1.f }, ERotationType::Euler_XYZ)         , this->m_scene.getDataSingleMatrix33f(containerHandle, DataFieldHandle(14u)));
