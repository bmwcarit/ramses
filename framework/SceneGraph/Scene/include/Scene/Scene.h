...
namespace ramses_internal
{
    ...
    public:
        ...
        [[nodiscard]] virtual SceneId                     getSceneId                      () const final override;
        [[nodiscard]] virtual const String&               getName                         () const final override;
        ...
        [[nodiscard]] virtual bool                        isRenderableAllocated           (RenderableHandle renderableHandle) const override final;
        [[nodiscard]] virtual UInt32                      getRenderableCount              () const override final;
        ...
        [[nodiscard]] virtual const Renderable&           getRenderable                   (RenderableHandle renderableHandle) const override final;
        ...
        [[nodiscard]] virtual bool                        isRenderStateAllocated          (RenderStateHandle stateHandle) const override final;
        [[nodiscard]] virtual UInt32                      getRenderStateCount             () const override final;
        ...
        [[nodiscard]] virtual const RenderState&          getRenderState                  (RenderStateHandle stateHandle) const override final;
        ...
        [[nodiscard]] virtual bool                        isCameraAllocated               (CameraHandle handle) const override final;
        [[nodiscard]] virtual UInt32                      getCameraCount                  () const override final;
        [[nodiscard]] virtual const Camera&               getCamera                       (CameraHandle cameraHandle) const override final;
        ...
        [[nodiscard]] virtual bool                        isNodeAllocated                 (NodeHandle node) const override final;
        [[nodiscard]] virtual UInt32                      getNodeCount                    () const override final;
        [[nodiscard]] virtual NodeHandle                  getParent                       (NodeHandle nodeHandle) const override final;
        ...
        [[nodiscard]] virtual UInt32                      getChildCount                   (NodeHandle parent) const override final;
        [[nodiscard]] virtual NodeHandle                  getChild                        (NodeHandle parent, UInt32 childNumber) const override final;
        ...
        [[nodiscard]] virtual UInt32                      getTransformCount               () const override final;
        [[nodiscard]] virtual bool                        isTransformAllocated            (TransformHandle transformHandle) const override final;
        [[nodiscard]] virtual NodeHandle                  getTransformNode                (TransformHandle handle) const override final;
        [[nodiscard]] virtual const Vector3&              getTranslation                  (TransformHandle handle) const override final;
        [[nodiscard]] virtual const Vector3&              getRotation                     (TransformHandle handle) const override final;
        [[nodiscard]] virtual ERotationConvention         getRotationConvention           (TransformHandle handle) const override final;
        [[nodiscard]] virtual const Vector3&              getScaling                      (TransformHandle handle) const override final;
        ...
        [[nodiscard]] virtual bool                        isDataLayoutAllocated           (DataLayoutHandle layoutHandle) const override final;
        [[nodiscard]] virtual UInt32                      getDataLayoutCount              () const override final;
        [[nodiscard]] virtual const DataLayout&           getDataLayout                   (DataLayoutHandle layoutHandle) const override final;
        ...
        [[nodiscard]] virtual bool                        isDataInstanceAllocated         (DataInstanceHandle containerHandle) const override final;
        [[nodiscard]] virtual UInt32                      getDataInstanceCount            () const override final;
        [[nodiscard]] virtual DataLayoutHandle            getLayoutOfDataInstance         (DataInstanceHandle containerHandle) const override final;
        [[nodiscard]] const DataInstanceMemoryPool&           getDataInstances                () const;

        [[nodiscard]] virtual const Float*                getDataFloatArray               (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector2*              getDataVector2fArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector3*              getDataVector3fArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector4*              getDataVector4fArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Int32*                getDataIntegerArray             (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix22f*            getDataMatrix22fArray           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix33f*            getDataMatrix33fArray           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix44f*            getDataMatrix44fArray           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector2i*             getDataVector2iArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector3i*             getDataVector3iArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector4i*             getDataVector4iArray            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const ResourceField&        getDataResource                 (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual TextureSamplerHandle        getDataTextureSamplerHandle     (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual DataInstanceHandle          getDataReference                (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        ...
        [[nodiscard]] virtual Float                       getDataSingleFloat              (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector2&              getDataSingleVector2f           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector3&              getDataSingleVector3f           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector4&              getDataSingleVector4f           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual Int32                       getDataSingleInteger            (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix22f&            getDataSingleMatrix22f          (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix33f&            getDataSingleMatrix33f          (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Matrix44f&            getDataSingleMatrix44f          (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector2i&             getDataSingleVector2i           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector3i&             getDataSingleVector3i           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        [[nodiscard]] virtual const Vector4i&             getDataSingleVector4i           (DataInstanceHandle containerHandle, DataFieldHandle field) const override final;
        ...
        [[nodiscard]] virtual bool                        isTextureSamplerAllocated       (TextureSamplerHandle handle) const override final;
        [[nodiscard]] virtual UInt32                      getTextureSamplerCount          () const override final;
        [[nodiscard]] virtual const TextureSampler&       getTextureSampler               (TextureSamplerHandle handle) const override final;
        ...
        [[nodiscard]] virtual bool                    isRenderGroupAllocated          (RenderGroupHandle groupHandle) const override final;
        [[nodiscard]] virtual UInt32                  getRenderGroupCount             () const override final;
        ...
        [[nodiscard]] virtual const RenderGroup&      getRenderGroup                  (RenderGroupHandle groupHandle) const override final;
        ...
        [[nodiscard]] virtual bool                    isRenderPassAllocated           (RenderPassHandle pass) const override final;
        [[nodiscard]] virtual UInt32                  getRenderPassCount              () const override final;
        ...
        [[nodiscard]] virtual const RenderPass&       getRenderPass                   (RenderPassHandle passHandle) const override final;
        ...
        [[nodiscard]] virtual bool                    isBlitPassAllocated             (BlitPassHandle passHandle) const override final;
        [[nodiscard]] virtual UInt32                  getBlitPassCount                () const override final;
        ...
        [[nodiscard]] virtual const BlitPass&         getBlitPass                     (BlitPassHandle passHandle) const override final;
        ...
        [[nodiscard]] virtual const PickableObject&   getPickableObject               (PickableObjectHandle pickableHandle) const override final;
        ...
        [[nodiscard]] virtual bool                    isRenderTargetAllocated         (RenderTargetHandle targetHandle) const override final;
        [[nodiscard]] virtual UInt32                  getRenderTargetCount            () const override final;
        virtual void                    addRenderTargetRenderBuffer     (RenderTargetHandle targetHandle, RenderBufferHandle bufferHandle) override;
        [[nodiscard]] virtual UInt32                  getRenderTargetRenderBufferCount(RenderTargetHandle targetHandle) const override final;
        [[nodiscard]] virtual RenderBufferHandle      getRenderTargetRenderBuffer     (RenderTargetHandle targetHandle, UInt32 bufferIndex) const override final;
        ...
        [[nodiscard]] virtual bool                    isRenderBufferAllocated         (RenderBufferHandle handle) const override final;
        [[nodiscard]] virtual UInt32                  getRenderBufferCount            () const override final;
        ...
        [[nodiscard]] virtual UInt32                  getDataBufferCount              () const override final;
        ...
        [[nodiscard]] virtual bool                    isDataBufferAllocated           (DataBufferHandle handle) const override final;
        [[nodiscard]] virtual const GeometryDataBuffer& getDataBuffer                 (DataBufferHandle handle) const override final;
        ...
        [[nodiscard]] virtual bool                    isTextureBufferAllocated        (TextureBufferHandle handle) const override final;
        [[nodiscard]] virtual UInt32                  getTextureBufferCount           () const override final;
        ...
        [[nodiscard]] virtual const TextureBuffer&    getTextureBuffer                (TextureBufferHandle handle) const override final;
        ...
        [[nodiscard]] virtual bool                    isDataSlotAllocated             (DataSlotHandle handle) const override final;
        [[nodiscard]] virtual UInt32                  getDataSlotCount                () const override final;
        [[nodiscard]] virtual const DataSlot&         getDataSlot                     (DataSlotHandle handle) const override final;
        ...
        [[nodiscard]] virtual SceneSizeInformation    getSceneSizeInformation         () const final override;
