...
namespace ramses_internal
{
    ...
    struct EffectInputInformation
    {
        ...
        inline EffectInputInformation(std::string_view inputName_, UInt32 elementCount_, EDataType dataType_, EFixedSemantics semantics_);
    ...
    EffectInputInformation::EffectInputInformation(std::string_view inputName_, UInt32 elementCount_, EDataType dataType_, EFixedSemantics semantics_)
