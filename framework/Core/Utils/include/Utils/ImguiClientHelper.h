...
namespace ramses_internal
{
    ...
    static const char* const ImguiFragShader = R"GLSL(
        #version 100
    ...
    static const char* const ImguiVertShader = R"GLSL(
        #version 100
    ...
    public:
        ...
        static uint32_t GetSpecialChar(ramses::EKeyCode keyCode, const bool isShift)
        {
            switch (keyCode)
            {
