...
namespace ramses_internal
{
    ...
    public:
        ...
        Image(UInt32 width, UInt32 height, std::vector<uint8_t>&& data);
        ...
        [[nodiscard]] UInt32 getNumberOfNonBlackPixels(uint8_t maxDiffPerColorChannel = 1) const;
        ...
        [[nodiscard]] Image createEnlarged(UInt32 width, UInt32 height, std::array<uint8_t, 4> fillValue = {0x0, 0x0, 0x0, 0xff}) const;
