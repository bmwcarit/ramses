...
namespace ramses_internal
{
    ...
    {
    public:
        TCPConnectionSystem(const NetworkParticipantAddress& participantAddress, uint32_t protocolVersion, const NetworkParticipantAddress& daemonAddress, bool pureDaemon,
