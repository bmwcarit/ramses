...
namespace ramses_internal
{
    ...
    public:
        ...
        MOCK_METHOD(void, handleContentDescription, (const SomeIPMsgHeader& header, ContentID content, TechnicalContentDescriptor technicalContentDescriptor), (override));
    ...
    public:
        ...
        MOCK_METHOD(bool, sendContentDescription, (DcsmInstanceId to, const SomeIPMsgHeader& header, ContentID content, TechnicalContentDescriptor technicalContentDescriptor), (override));
