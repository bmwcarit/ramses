...
namespace ramses
{
    ...
    {
        LOG_INFO(ramses_internal::CONTEXT_DCSM, "DcsmProvider::requestContentFocus: contentID " << contentID);
    ...
    {
        LOG_INFO(ramses_internal::CONTEXT_DCSM, "DcsmProvider::contentSizeChange: contentID " << contentID << ", SizeInfo "
