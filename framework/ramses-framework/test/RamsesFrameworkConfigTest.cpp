...
TEST_F(ARamsesFrameworkConfig, IsInitializedCorrectly)
{
    ...
    EXPECT_EQ(ERamsesShellType::Default, frameworkConfig.m_impl.get().m_shellType);
}
...
TEST_F(ARamsesFrameworkConfig, CanBeCopyAndMoveConstructed)
{
    ...
    EXPECT_EQ(ERamsesShellType::Console, configCopy.m_impl.get().m_shellType);

    RamsesFrameworkConfig configMove{ std::move(frameworkConfig) };
    EXPECT_EQ(ERamsesShellType::Console, configMove.m_impl.get().m_shellType);
}
...
#pragma clang diagnostic ignored "-Wself-assign-overloaded"
    ...
    EXPECT_EQ(ERamsesShellType::Console, frameworkConfig.m_impl.get().m_shellType);
...
TEST_F(ARamsesFrameworkConfig, CanSetShellTypeNone)
{
    ...
    EXPECT_EQ(ERamsesShellType::None, frameworkConfig.m_impl.get().m_shellType);
}
