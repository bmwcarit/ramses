...
namespace ramses
{
    ...
    */
    ...
    public:
        ...
        */
        [[nodiscard]] status_t validate() const;
        ...
        */
        [[nodiscard]] const char* getValidationReport(EValidationSeverity minSeverity = EValidationSeverity_Info) const;
        ...
        */
        [[nodiscard]] const char* getStatusMessage(status_t status) const;
