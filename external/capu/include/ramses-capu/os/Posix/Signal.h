...
#ifndef RAMSES_CAPU_UNIXBASED_SIGNAL_H
#define RAMSES_CAPU_UNIXBASED_SIGNAL_H
...
namespace ramses_capu
{
    ...
    namespace posix
    {
        ...
        public:
            ...
            {
                int32_t retval = ::raise(static_cast<int32_t>(sig));
...
#endif // RAMSES_CAPU_UNIXBASED_SIGNAL_H
