...
ramses::Scene& createMainScene(ramses::RamsesClient& client, ramses::sceneId_t sceneId, const std::string& processingOutputSamplerName)
{
    ...
    ramses::TextureSampler& streamtextureSampler = *clientScene->createTextureSampler(ramses::ETextureAddressMode::Repeat,
    ...
    ramses::TextureSampler& outputTextureSampler = *clientScene->createTextureSampler(ramses::ETextureAddressMode::Repeat,
                                                                                ramses::ETextureAddressMode::Repeat,
                                                                                ramses::ETextureSamplingMethod::Linear,
                                                                                ramses::ETextureSamplingMethod::Linear,
                                                                                fallbackTexture,
