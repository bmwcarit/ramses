...
int main()
{
    ...
    ramses::Scene* scene = ramses.createScene(sceneConfig, "basic renderpasses scene");
    ...
    std::optional<ramses::UniformInput> color = effectTex->findUniformInput("color");
    ...
    meshNodeC->setGeometry(*geometry);
