...
int main(int argc, char* argv[])
{
    ...
    ramses::RamsesClient& ramses(*framework.createClient("ramses-example-basic-animation"));
    framework.connect();

    // create a scene for distributing content
    ramses::Scene* scene = ramses.createScene(ramses::sceneId_t(123u), ramses::SceneConfig(), "red triangle scene");
