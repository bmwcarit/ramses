...
int main()
{
    ...
    */
    ramses::NodeBinding* nodeBinding = logicEngine.createNodeBinding(*tri);
    ...
    /**
    * Connect the animation channel 'translation' output with the translation property of the NodeBinding object.
...
SceneAndNode CreateSceneWithTriangle(ramses::RamsesClient& client)
{
    ramses::Scene* scene = client.createScene(ramses::sceneId_t(123u), "triangle scene");
