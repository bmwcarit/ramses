...
int main(int argc, char* argv[])
{
    ...
    effectDescription.setVertexShaderFromFile("res/embeddedCompositing-texturing.vert");
    effectDescription.setFragmentShaderFromFile("res/embeddedCompositing-texturing.frag");
