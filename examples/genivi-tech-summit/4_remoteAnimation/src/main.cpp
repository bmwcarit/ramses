...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    addTexturedQuad({ A, B, C, D }, client, *scene, "res/remoteAnimation-face-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ B, E, D, G }, client, *scene, "res/remoteAnimation-face-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ C, D, H, G }, client, *scene, "res/remoteAnimation-face-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ E, F, G, H }, client, *scene, "res/remoteAnimation-face-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ F, A, H, C }, client, *scene, "res/remoteAnimation-face-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ F, E, A, B }, client, *scene, "res/remoteAnimation-face-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
